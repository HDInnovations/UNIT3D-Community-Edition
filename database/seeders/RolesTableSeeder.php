...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Role::upsert([
            ...
            ['slug' => 'guest', 'name' => 'Validating', 'position' => 004, 'icon' => config('other.font-awesome').' fa-user-secret', 'color' => '#00abff', 'effect' => 'url(/img/sparkels.gif)', 'system_required' => true],
            ['slug' => 'banned', 'name' => 'Banned', 'position' => 005, 'icon' => config('other.font-awesome').' fa-user-secret', 'color' => '#00abff', 'effect' => 'url(/img/sparkels.gif)', 'system_required' => true],
            ...
            ['slug' => 'group_7', 'name' => 'Seeder User', 'position' =>107, 'icon' => config('other.font-awesome').' fa-user-secret', 'color' => '#00abff', 'effect' => 'url(/img/sparkels.gif)', 'system_required' => true],
            ['slug' => 'group_8', 'name' => 'Archive User', 'position' =>108, 'icon' => config('other.font-awesome').' fa-user-secret', 'color' => '#00abff', 'effect' => 'url(/img/sparkels.gif)', 'system_required' => true],
            ['slug' => 'leech', 'name' => 'Leech', 'position' => 99, 'icon' => config('other.font-awesome') . ' fa-user-secret', 'color' => '#00abff', 'effect' => 'url(/img/sparkels.gif)', 'system_required' => true],
