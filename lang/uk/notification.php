...
return [
    'already-marked-read' => 'Нотифікації Вже Помічені Як Прочитані!',
    'all-deleted'         => 'Всі Нотифікації Видалено!',
    'all-marked-read'     => 'Всі Нотифікації Помічені Як Прочитані!',
    'bon-gifts'           => 'Подарунки бонусів',
    'comment-tags'        => 'Згадки в коментарях',
    'date'                => 'Дата',
    'delete'              => 'Видалити',
    'delete-all'          => 'Видалити всі нотифікації',
    'deleted'             => 'Нотифікацію Видалено!',
    'filter-by-type'      => 'Відбір по типам нотифікацій',   
    'mark-all-read'       => 'Позначити всі як прочитані',
    'mark-read'           => 'Позначити як прочитане',
    'marked-read'         => 'Нотифікацію Позначено Як Прочитану!',
    'message'             => 'Повідомлення',
    'no-notifications'    => 'Не знайдено жодних нотифікацій',
    'not-existent'        => 'Нотифікацій Немає!',
