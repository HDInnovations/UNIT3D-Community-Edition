...
readonly class TorrentSearchFiltersDTO
{
    ...
    {
        $isRegexAllowed = $this->user->group->is_modo || $this->user->group->is_editor;
    ...
    final public function toMeilisearchFilter(): array
    {
        ...
        if ($this->uploader !== '') {
            $filters[] = 'uploader = '.json_encode($this->uploader);
        }
        ...
        if ($this->startYear !== null) {
            $filters[] = 'release_year >= '.$this->startYear;
        }

        if ($this->endYear !== null) {
            $filters[] = 'release_year <= '.$this->endYear;
        }
        ...
        if ($this->companyId !== null) {
            $filters[] = 'company_ids = '.$this->companyId;
        }

        if ($this->networkId !== null) {
            $filters[] = 'network_ids = '.$this->networkId;
        }
