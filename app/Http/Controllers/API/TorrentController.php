...
class TorrentController extends \App\Http\Controllers\API\BaseController
{
    ...
    public function store(\Illuminate\Http\Request $request)
    {
        ...
        $torrent = \app()->make(\App\Models\Torrent::class);
        ...
        $torrent->moderated_by = \App\Models\User::where('username', 'System')->first()->id;
        //System ID
        ...
        if ($torrent->featured == 1) {
            $featuredTorrent = new \App\Models\FeaturedTorrent();
