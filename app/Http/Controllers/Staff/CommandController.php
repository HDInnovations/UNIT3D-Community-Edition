...
class CommandController extends Controller
{
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function maintanceDisable(\Illuminate\Http\Request $request)
    {
        $user = $request->user();
        abort_unless($user->group->is_owner, 403);
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function clearView(\Illuminate\Http\Request $request)
    {
        $user = $request->user();
        abort_unless($user->group->is_owner, 403);
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function clearRoute(\Illuminate\Http\Request $request)
    {
        $user = $request->user();
        abort_unless($user->group->is_owner, 403);
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function clearConfig(\Illuminate\Http\Request $request)
    {
        $user = $request->user();
        abort_unless($user->group->is_owner, 403);
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function clearAllCache(\Illuminate\Http\Request $request)
    {
        $user = $request->user();
        abort_unless($user->group->is_owner, 403);
     ...
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
    public function setAllCache(\Illuminate\Http\Request $request)
    {
        $user = $request->user();
        abort_unless($user->group->is_owner, 403);
