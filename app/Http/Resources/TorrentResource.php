    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'attributes'    => [
                ...
                'type'              => $this->type->name,
                'resolution'        => $this->when(property_exists($this, 'resolution_id') && $this->resolution_id !== null, $this->resolution->name ?? ''),
                'distributor'       => $this->when(property_exists($this, 'distributor_id') && $this->distributor_id !== null, $this->distributor->name ?? ''),
                'region'            => $this->when(property_exists($this, 'region_id') && $this->region_id !== null, $this->region->name ?? ''),
