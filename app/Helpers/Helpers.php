...
if (!\function_exists('language_flag')) {
    function language_flag(?string $language): ?string
    {
        ...
        $flag = match ($language) {
            ...
            'Czech', 'Czech (CZ)' => 'cz',
            'Danish', 'Danish (DK)' => 'dk',
            'Dutch', 'Dutch (NL)', 'Limburgish', 'dum' => 'nl',
            'Dutch (BE)' => 'be',
            'Estonian', 'Estonian (EE)' => 'ee',
            'Finnish', 'Finnish (FI)' => 'fi',
            'French', 'French (FR)', 'frm' => 'fr',
            'French (CA)' => 'can-qc',
            'Georgian' => 'ge',
            'German', 'German (DE)', 'gmh', 'gml' => 'de',
            'German (CH)' => 'ch',
            'Greek', 'Greek (GR)' => 'gr',
            'Hebrew', 'Hebrew (IL)' => 'il',
            ...
            'Irish', 'Irish (IE)', 'mga' => 'ie',
            'Italian', 'Italian (IT)' => 'it',
            'Japanese', 'Japanese (JP)' => 'jp',
            'Kazakh', 'Kazakh (KZ)' => 'kz',
            'Korean', 'Korean (KR)', 'okm' => 'kr',
