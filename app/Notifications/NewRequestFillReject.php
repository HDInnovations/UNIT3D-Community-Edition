...
class NewRequestFillReject extends Notification implements ShouldQueue
{
    ...
    public function shouldSend(User $notifiable): bool
    {
        ...
        return ! (\is_array($notifiable->notification->json_request_groups) && \in_array($this->torrentRequest->user->group_id, $notifiable->notification->json_request_groups, true))
        ;
    }
