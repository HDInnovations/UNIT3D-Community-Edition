 ...
 * @property int                                                                    $stream
 * @property int                                                                    $free
 * @property int                                                                    $promo25
 * @property int                                                                    $promo50
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Torrent wherePromo25($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Models\Torrent wherePromo50($value)
...
class Torrent extends Model
{
     ...
     * @return bool
     */
    public function isPromo25($user = null)
    {
        $pPromo25 = $user ? $user->group->is_freeleech || PersonalFreeleech::where('user_id', '=', $user->id)->first() : false;
     ...
     * @return bool
     */
    public function isPromo50($user = null)
    {
        $pPromo50 = $user ? $user->group->is_freeleech || PersonalFreeleech::where('user_id', '=', $user->id)->first() : false;
