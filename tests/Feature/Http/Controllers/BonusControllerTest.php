...
test('bonus returns an ok response', function () {
...
test('upload exchange returns an ok response', function () {
...
test('download exchange returns an ok response', function () {
    // User's seed bonus must be >= cost for exchange to succeed.
...
test('personal freeleech exchange returns an ok response', function () {
    // User's seed bonus must be >= cost for exchange to succeed.
...
test('gift returns an ok response', function () {
    $user = User::factory()->create();
...
test('gifts returns an ok response', function () {
    $user = User::factory()->create();
...
test('send gift returns an ok response', function () {
...
test('tip poster returns an ok response', function () {
...
test('tip uploader returns an ok response', function () {
    // User's seed bonus must be >= tip amount for exchange to succeed.
...
test('tips returns an ok response', function () {
    $user = User::factory()->create();
