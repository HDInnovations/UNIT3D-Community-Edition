...
test('user comments own ticket does not create a notification for self but staff', function (): void {
    Notification::fake();
...
test('staff comments a ticket does not create a notification for the user when all notifications are disabled', function (): void {
    Notification::fake();
