...
test('post in a topic creates a notification for the topic subscriber', function (): void {
    ...
    $topicOwnerNotificationSettings = UserNotification::create([
        'user_id'             => $topicOwner->id,
        'block_notifications' => 1,
    ]);
    $subscriberNotificationSettings = UserNotification::create([
...
test('post in a topic creates a notification for the topic subscriber when all notifications disabled', function (): void {
    Notification::fake();
...
test('post in a topic creates a notification for the topic subscriber when topic subscription notifications are disabled', function (): void {
    Notification::fake();
...
test('post in a topic creates a notification for the topic subscriber when topic subscription notifications are disabled for specific group', function (): void {
    Notification::fake();
