...
@section('content')
    <div id="torrent-page">
        ...
        <div class="meta-general box container">
            ...
            @if (auth()->user()->group->is_modo || auth()->user()->id === $uploader->id || auth()->user()->group->is_internal || auth()->user()->group_id === 29)
                            ...
                            <tbody>
                                <tr>
                                    <td style="display: flex; justify-content: space-around; padding: 10px 0">
                                        @if (auth()->user()->group->is_modo || auth()->user()->id === $uploader->id || auth()->user()->group_id === 29)
