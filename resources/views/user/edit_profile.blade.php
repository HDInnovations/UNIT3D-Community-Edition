...
@section('content')
    <div class="container">
        <div class="block block-form">
            ...
            <div class="form-group">
                <label for="about">{{ trans('user.about-me') }} <span
                            class="badge-extra">BBCode {{ trans('common.is-allowed') }}</span></label>
                <textarea name="about" cols="30" rows="10" maxlength="500"
                          class="form-control">{{ $user->about }}</textarea>
            </div>

            <div class="form-group">
                <label for="signature">{{ trans('user.forum-signature') }} <span
                            class="badge-extra">BBCode {{ trans('common.is-allowed') }}</span></label>
