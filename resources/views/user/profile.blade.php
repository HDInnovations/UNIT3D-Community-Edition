                    ...
                    <div class="inner_content">
                        <div class="content">
                            ...
                            <div class="col-lg-10">
                                <h2>{{ $user->username }}
                                    @if ($user->isOnline())
                                        <i class="{{ config('other.font-awesome') }} fa-circle text-green"
                                            data-toggle="tooltip" title="" data-original-title="@lang('user.online')"></i>
                                    @else
                                        <i class="{{ config('other.font-awesome') }} fa-circle text-red"
                                            data-toggle="tooltip" title="" data-original-title="@lang('user.offline')"></i>
                                    @endif
                                    <a
                                        href="{{ route('create', ['receiver_id' => $user->id, 'username' => $user->username]) }}">
                                        <i class="{{ config('other.font-awesome') }} fa-envelope text-info"></i>
                                    </a>
                                    <a href="#modal_user_gift" data-toggle="modal" data-target="#modal_user_gift"><i
                                    ...
                                    @if ($user->notes->count() > 0 && auth()->user()->group->is_modo)
                                        <a href="{{ route('user_setting', ['username' => $user->username]) }}"
                                            ...
                                            <i class="{{ config('other.font-awesome') }} fa-comment fa-beat text-danger"
                                                aria-hidden="true" data-toggle="tooltip" title=""
                                                data-original-title="@lang('user.staff-noted')">
                                            </i>
                                        </a>
                                    @endif
                                    @php
                                    ...
                                    @if ($watched && auth()->user()->group->is_modo)
                                        <i class="{{ config('other.font-awesome') }} fa-eye fa-beat text-danger"
                                            aria-hidden="true" data-toggle="tooltip" title=""
                                            data-original-title="User is being watched!">
                                        </i>
                                    @endif
                                </h2>
                                ...
                                <h4>@lang('user.registration-date')
                                    ...
                                    <span style="float:right;">
                                        @if (auth()->user()->group->is_modo)
                                            <button class="btn btn-xs btn-warning" data-toggle="modal"
                                                ...
                                                @lang('user.note') </button>
                                            @if (!$watched)
                                                <button class="btn btn-xs btn-danger" data-toggle="modal"
                                                    data-target="#modal_user_watch">
                                                    <span class="{{ config('other.font-awesome') }} fa-eye"></span> Watch
                                                </button>
                                            @else
                                            ...
                                            @if ($user->group->id == 5)
                                                <button class="btn btn-xs btn-warning" data-toggle="modal"
                                                    data-target="#modal_user_unban"><span
                                                        class="{{ config('other.font-awesome') }} fa-undo"></span>
                                                    @lang('user.unban') </button>
                                            @else
                                                <button class="btn btn-xs btn-danger" data-toggle="modal"
                                                    data-target="#modal_user_ban"><span
                                                        class="{{ config('other.font-awesome') }} fa-ban"></span>
                                                    @lang('user.ban')</button>
                                            @endif
                                            <a href="{{ route('user_setting', ['username' => $user->username]) }}"
                                                class="btn btn-xs btn-warning"><span
                                                    class="{{ config('other.font-awesome') }} fa-pencil"></span>
                                                @lang('user.edit') </a>
                                            <button class="btn btn-xs btn-danger" data-toggle="modal"
                                                data-target="#modal_user_delete"><span
                                                    class="{{ config('other.font-awesome') }} fa-trash"></span>
                        ...
                        <tbody>
                            ...
                            @if (auth()->user()->isAllowed($user, 'profile', 'show_profile_torrent_ratio'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge-user group-member">{{ $user->untilRatio(config('other.ratio')) }}</span>
                                    </td>
                                </tr>
                            @endif
                            @if (auth()->user()->isAllowed($user, 'profile', 'show_profile_torrent_seed'))
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge-user group-member">{{ App\Helpers\StringHelper::formatBytes($user->getTotalSeedSize(), 2) }}</span>
                                    </td>
                                </tr>
                            @endif
                            <tr>
                                        ...
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.tips-received'):</strong>
                                                    <span
                                                        class="text-pink text-bold">{{ \number_format(
    $user->bonReceived()->where('name', '=', 'tip')->sum('cost'),
    0,
    '.',
    ' ',
) }}
                                            ...
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.tips-given'):</strong>
                                                    <span
                                                        class="text-pink text-bold">{{ \number_format(
    $user->bonGiven()->where('name', '=', 'tip')->sum('cost'),
    0,
    '.',
    ' ',
) }}
                                            ...
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.gift-received'):</strong>
                                                    <span
                                                        class="text-pink text-bold">{{ \number_format(
    $user->bonReceived()->where('name', '=', 'gift')->sum('cost'),
    0,
    '.',
    ' ',
) }}
                                            ...
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.gift-given'):</strong>
                                                    <span
                                                        class="text-pink text-bold">{{ \number_format(
    $user->bonGiven()->where('name', '=', 'gift')->sum('cost'),
    0,
    '.',
    ' ',
) }}
                                            ...
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.bounty-received'):</strong>
                                                    <span
                                                        class="text-pink text-bold">{{ \number_format(
    $user->bonReceived()->where('name', '=', 'request')->sum('cost'),
    0,
    '.',
    ' ',
) }}
                                            ...
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.bounty-given'):</strong>
                                                    <span
                                                        class="text-pink text-bold">{{ \number_format(
    $user->bonGiven()->where('name', '=', 'request')->sum('cost'),
    0,
    '.',
    ' ',
) }}
                                        ...
                                        <ul class="list-inline mb-0">
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.article-comments'):</strong>
                                                    <span
                                                        class="text-green text-bold">{{ $user->comments()->where('article_id', '>', 0)->count() }}</span>
                                                </span>
                                            </li>
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.torrent-comments'):</strong>
                                                    <span
                                                        class="text-green text-bold">{{ $user->comments()->where('torrent_id', '>', 0)->count() }}</span>
                                                </span>
                                            </li>
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.request-comments'):</strong>
                                                    <span
                                                        class="text-green text-bold">{{ $user->comments()->where('requests_id', '>', 0)->count() }}</span>
                                                </span>
                                            </li>
                                        </ul>
                                    </td>
                                        ...
                                        <ul class="list-inline mb-0">
                                            <li>
                                                <span class="badge-extra"><strong>@lang('user.topics-started'):</strong>
                                                    <span
                                                        class="text-green text-bold">{{ $user->topics->count() }}</span>
                                                </span>
                                            </li>
                                            <li>
                                    ...
                                    <td colspan="2" class="text-right">
                                        ...
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-danger progress-bar-striped active"
                                                role="progressbar" style="width:0; border-bottom-color: #8c0408;">
                                            </div>
                        ...
                        @if (auth()->user()->isAllowed($user, 'profile', 'show_profile_badge'))
                            @if ($user->getSeeding() >= '150')
                                <span class="badge-user" style="background-color:#3fb618; color:rgb(255,255,255);"
                                    ...
                                    data-original-title="@lang('user.certified-seeder-desc')"><i
                                        class="{{ config('other.font-awesome') }} fa-upload"></i>
                                    @lang('user.certified-seeder')!</span>
                            @endif
                            @if ($history->where('actual_downloaded', '>', 0)->count() >= '100')
                                <span class="badge-user" style="background-color:#ff0039; color:rgb(255,255,255);"
                                    data-toggle="tooltip" title=""
                                    data-original-title="@lang('user.certified-downloader-desc')"><i
                                        class="{{ config('other.font-awesome') }} fa-download"></i>
                                    @lang('user.certified-downloader')!</span>
                            @endif
                            @if ($user->getSeedbonus() >= '50,000')
                                <span class="badge-user" style="background-color:#9400d3; color:rgb(255,255,255);"
                                    data-toggle="tooltip" title=""
                                    data-original-title="@lang('user.certified-banker-desc')"><i
                                        class="{{ config('other.font-awesome') }} fa-coins"></i>
                                    @lang('user.certified-banker')!</span>
                            @endif
                        @endif
                    </div>
                </div>
                            ...
                            <tbody>
                                        ...
                                        @if ($invitedBy)
                                            <a
                                                ...
                                                <span class="text-bold"
                                                    style="color:{{ $invitedBy->sender->group->color }}; ">
                                                    <i class="{{ $invitedBy->sender->group->icon }}"></i>
                                    ...
                                    <td>
                                        <div class="col-md-2">
                                            <button type="button" class="btn btn-xxs btn-info collapsed"
                                                data-toggle="collapse" data-target="#pid_block"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        ({{ $user->last_login->diffForHumans() }})@else N/A @endif
                                    </td>
                                </tr>
                                <tr>
