                ...
                <div class="tab-content">
                    ...
                    <form role="form" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="language" name="language">
                                    @foreach (App\Models\Language::allowed() as $code => $name)
                                        <option @if (auth()->user()->locale == $code) selected @endif value="{{ $code }}">
                                            {{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="well">
                            ...
                            <div class="form-group">
                                <label for="custom_css" class="control-label">External CSS Stylesheet (Stacks on top of
                                    above theme)</label>
                                <label>
                                    <input type="text" name="custom_css" class="form-control" value="@if ($user->custom_css) {{ $user->custom_css }} @endif"
                                    placeholder="CSS URL">
                                </label>
                            </div>
                            <div class="form-group">
                                <label for="standalone_css" class="control-label">Standalone CSS Stylesheet (No site theme
                                    used)</label>
                                <label>
                                    <input type="text" name="standalone_css" class="form-control" value="@if ($user->standalone_css) {{ $user->standalone_css }} @endif"
                                    placeholder="CSS URL">
                                </label>
                            </div>
                        ...
                        <div class="well">
                            ...
                            <div class="radio-inline">
                                <label><input type="radio" name="censor" @if ($user->censor == 1) checked @endif value="1">@lang('common.yes')</label>
                            </div>
                            <div class="radio-inline">
                            ...
                            <div class="radio-inline">
                                <label><input type="radio" name="chat_hidden" @if ($user->chat_hidden == 1) checked @endif
                                        value="1">@lang('common.yes')</label>
                            </div>
                            <div class="radio-inline">
                                <label><input type="radio" name="chat_hidden" @if ($user->chat_hidden == 0) checked @endif
                        ...
                        <div class="well">
                            ...
                            <div class="radio-inline">
                                <label><input type="radio" name="show_poster" @if ($user->show_poster == 1) checked @endif
                                        value="1">@lang('common.yes')</label>
                            </div>
                            <div class="radio-inline">
                                <label><input type="radio" name="show_poster" @if ($user->show_poster == 0) checked @endif
                                        value="0">@lang('common.no')</label>
                            </div>
                            <br>
                            <br>
