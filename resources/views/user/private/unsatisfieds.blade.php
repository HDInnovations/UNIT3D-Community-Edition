...
@section('title')
    <title>{{ $user->username }} {{ __('user.unsatisfieds') }} - {{ config('other.title') }}</title>
@endsection
        ...
        <div class="block">
            ...
            <div class="container well search mt-5">
                <div class="form-horizontal form-condensed form-torrent-search form-bordered">
                    ...
                    <div class="mx-0 mt-5 form-group fatten-me">
                        <label for="name"
                               class="mt-5 col-sm-1 label label-default fatten-me">{{ __('torrent.seeding') }}</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mx-0 mt-5 form-group fatten-me">
                        ...
                        <div class="col-sm-2">
                            <label for="sorting"></label><select id="sorting" name="sorting" trigger="change"
                                ...
                                <option value="satisfied_at">{{ __('torrent.satisfied_in') }}</option>
                    ...
                    <div class="mx-0 mt-5 form-group fatten-me">
                        ...
                        <div class="col-sm-2">
                            <label for="direction"></label><select id="direction" name="direction" trigger="change"
                                ...
                                <option value="asc" selected>{{ __('common.ascending') }}</option>
                            </select>
                        </div>
                    </div>
                </div>
                            ...
                            <tr class="userFiltered" active="{{ $download->active ? '1' : '0' }}"
                                ...
                                <td>
                                    @if ($download->seeder == 1)
                                        <span
                                                class='label label-success'>{{ strtoupper(__('torrent.downloaded')) }}</span>
                                    @else
                                        <span
