                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge-extra text-green text-bold">
                                            {{ $upload->tipped_total ? $upload->tipped_total : 'N/A' }}</span>
                                    </td>
                                    <td>
                                        <span class="badge-extra text-red text-bold">
                                            {{ $upload->thanked_total ? $upload->thanked_total : 'N/A' }}</span>
                                    </td>
