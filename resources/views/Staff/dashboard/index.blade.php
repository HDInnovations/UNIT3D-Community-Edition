                    ...
                    <div class="panel-body">
                        @if (request()->secure())
                            ...
                            <div class="text-center" style="padding-top: 15px;">
                                <span class="text-red">Issued By: {{ (gettype($certificate) !== 'string') ? $certificate->getIssuer() : "No Certificate Issued" }}</span>
                                <br>
                                <span class="text-red">Expires: {{ (gettype($certificate) !== 'string') ? $certificate->expirationDate()->diffForHumans() : "No Certificate Issued" }}</span>
                            </div>
                        @else
