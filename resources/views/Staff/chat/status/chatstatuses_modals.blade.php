        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('staff.statuses.update', ['id' => $chatstatus->id]) }}">
                ...
                <div class="modal-body"  style="text-align: center;">
                    ...
                    <label for="chatstatus_name"> @lang('common.name'):</label> <label for="name"></label><input style="margin:0 auto; width:300px;" type="text" class="form-control" name="name" id="name" placeholder="Enter @lang('common.name') Here..." value="{{ $chatstatus->name }}" required>
    ...
    <div class="modal-dialog modal-dark">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('staff.statuses.destroy', ['id' => $chatstatus->id]) }}">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-md btn-default" data-dismiss="modal">@lang('common.cancel')</button>
