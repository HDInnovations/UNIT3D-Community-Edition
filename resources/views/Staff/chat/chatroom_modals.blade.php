...
<div id="editChatroom-{{ $chatroom->id }}" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('staff.chatroom.update', ['id' => $chatroom->id]) }}">
            @csrf
...
<div id="deleteChatroom-{{ $chatroom->id }}" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('staff.chatroom.destroy', ['id' => $chatroom->id]) }}">
            @csrf
