    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" class=""><a href="#permissions" aria-controls="permissions" role="tab"
                                                data-toggle="tab"
                    aria-expanded="false">{{__('user.roles and privileges')}}</a></li>
        ...
        <div class="tab-content block block-titled">
            <div role="tabpanel" class="tab-pane active" id="account">
                ...
                <form role="form" method="POST" action="{{ route('user_edit', ['username' => $user->username]) }}">
                    ...
                    <div class="form-group">
                        <label for="about">{{ __('common.primary role') }}</label>
                        <label>
            ...
            <div role="tabpanel" class="tab-pane" id="permissions">
                <h3>{{__('user.roles and privileges')}}</h3>
                <hr>
                <h4>{{__('user.privileges')}}</h4>
                <hr>
