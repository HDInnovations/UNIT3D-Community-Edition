                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST"
                            ...
                            <div class="form-group{{ $errors->has('imdb') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="imdb" type="text" class="form-control" name="imdb"
                                           value="{{ old('imdb') }}" required autofocus>
                                    @if ($errors->has('imdb'))
                  ...
                  <strong>{{ $errors->first('imdb') }}</strong>
                            ...
                            <div class="form-group{{ $errors->has('tvdb') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="tvdb" type="text" class="form-control" name="tvdb"
                                           value="{{ old('tvdb') }}" required autofocus>
                                    @if ($errors->has('tvdb'))
                                        <span class="help-block">
