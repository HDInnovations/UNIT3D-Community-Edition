...
@section('content')
                ...
                <tbody>
                    @foreach ($pending as $p)
                        <tr>
                            ...
                            <td>{{ $p->getSize() }}</td>
                            <td><a href="{{ route('users.show', ['username' => $p->user->username]) }}" itemprop="url"
                                    class="l-breadcrumb-item-link"><span itemprop="title"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <p id="title" name="title" class="form-control-static">
                                                                {{ $p->name }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
    ...
    <div class="text-center">
        <h1>@lang('torrent.postponed-torrents')</h1>
    </div>
    <div class="container box">
        <div class="table-responsive">
            <table class="table table-condensed table-striped table-bordered">
                ...
                <tbody>
                    @foreach ($postponed as $post)
                        <tr>
                            ...
                            <td>{{ $post->getSize() }}</td>
                            <td>
                                <a href="{{ route('users.show', ['username' => $post->user->username]) }}" itemprop="url"
                                    class="l-breadcrumb-item-link"><span itemprop="title"
                                        class="l-breadcrumb-item-link-title">{{ $post->user->username }}
                                        ({{ $post->user->group->name }})</span></a>
                            </td>
                            <td>
                                <a href="{{ route('users.show', ['username' => $post->moderated->username]) }}"
                                    itemprop="url" class="l-breadcrumb-item-link"><span itemprop="title"
                                        ...
                                        ({{ $post->moderated->group->name }})</span></a>
                            </td>
                            ...
                            <td><a href="{{ route('edit', ['id' => $post->id]) }}" role='button'
                                    class='btn btn-labeled btn-info'><span class="btn-label"><i
                                            class="{{ config('other.font-awesome') }} fa-pencil"></i></span>@lang('common.edit')</a>
                            </td>
                            <td>
                                        ...
                                        <div class="modal-dialog{{ \modal_style() }}">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" id="myModalLabel">
                                                        @lang('common.delete') @lang('torrent.torrent'):
                                                        {{ $post->name }}
                                                    </h4>
                                                </div>
                                                <div class="modal-body">
                ...
                <tbody>
                    @foreach ($rejected as $reject)
                        <tr>
                            ...
                            <td><a href="{{ route('torrent', ['id' => $reject->id]) }}" itemprop="url"
                                    class="l-breadcrumb-item-link"><span itemprop="title"
