...
@section('breadcrumb')
    ...
    <li class="active">
        <a href="{{ route('staff_groups_edit', array('group' => $group->name, 'id' => $group->id)) }}" itemprop="url"
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td><input type="text" name="group_postion" value="{{ $group->position }}" class="form-control"/>
                    </td>
