        ...
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td><input type="number" name="group_postion" value="" placeholder="Position" class="form-control"/>
                    </td>
                    <td><input type="text" name="group_color" value="" placeholder="HEX Color ID" class="form-control"/>
                    </td>
                    <td><input type="text" name="group_icon" value="" placeholder="FontAwesome Icon"
                               class="form-control"/></td>
                    <td><input type="text" name="group_effect" value="" placeholder="GIF Effect" class="form-control"/>
                    </td>
                    <td>
