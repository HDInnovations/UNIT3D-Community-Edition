        ...
        <header class="panel__header">
            ...
            <div class="panel__actions">
                <div class="panel__action">
                    <a href="{{ route('staff.bon_earnings.create') }}" class="form__button form__button--text">
                        {{ __('common.add') }}
        ...
        <div class="data-table-wrapper">
            <table class="data-table">
                ...
                @foreach ($bonEarnings as $bonEarning)
                    <tr>
                        <td>
                            <a href="{{ route('staff.bon_earnings.edit', ['bonEarning' => $bonEarning]) }}">
                                {{ $bonEarning->name }}
                            </a>
                        </td>
                        ...
                        <td>
                            <ul>
                                @forelse ($bonEarning->conditions as $condition)
                                    <li>{{ $condition->operand1 }} {{ $condition->operator }} {{ $condition->operand2 }}</li>
                                @empty
                                    <li>No conditions</li>
                                @endforelse
                            </ul>
