    ...
    <div class="container movie-container">
        <div class="row movie-row ">
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-sm-push-4 col-md-push-3 movie-heading-box">
                ...
                <span class="movie-details">
                    @if ($torrentRequest->category->movie_meta || $torrentRequest->category->tv_meta && $torrentRequest->imdb != 0 &&
                        $torrentRequest->imdb != null)
                        <span class="badge-user text-bold text-orange">
                    ...
                    @if ($torrentRequest->category->movie_meta && $torrentRequest->tmdb != 0 && $torrentRequest->tmdb != null)
                        <span class="badge-user text-bold text-orange">
                            <a href="https://www.themoviedb.org/movie/{{ $torrentRequest->tmdb }}" title="TheMovieDatabase"
                               target="_blank">
                                <i class="{{ config('other.font-awesome') }} fa-film"></i> TMDB: {{ $torrentRequest->tmdb }}
                            </a>
                        </span>
                    ...
                    @if (($torrentRequest->category->movie_meta || $torrentRequest->category->tv_meta) && $torrentRequest->mal != 0 &&
                        $torrentRequest->mal != null)
