...
<div class="block">
  ...
  <a href="{{ route('add_request') }}" role="button" data-id="0" data-toggle="tooltip" title="" data-original-title="{{ trans('add-request') }}!" class="btn btn btn-success">{{ trans('add-request') }}</a>
