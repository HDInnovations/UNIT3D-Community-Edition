            ...
            <div class="block">
                <form role="form" method="POST" action="{{ route('edit', ['id' => $torrent->id]) }}"
                                ...
                                <select name="resolution_id" class="form-control">
                                    @if (!$torrent->resolution)
                                        <option hidden="" disabled="disabled" selected="selected" value="">--Select
                                            Resolution--</option>)
                                    @else
                                        <option value="{{ $torrent->resolution->id }}" selected>
                    ...
                    <div class="radio-inline">
                        <label><input type="radio" name="anonymous" @if ($torrent->anon == 1) checked @endif value="1">@lang('common.yes')</label>
                    </div>
                    <div class="radio-inline">
                        <label><input type="radio" name="anonymous" @if ($torrent->anon == 0) checked @endif value="0">@lang('common.no')</label>
                    </div>
                    <br>
                    <br>
                    <label for="hidden" class="control-label">@lang('torrent.stream-optimized')?</label>
                    <div class="radio-inline">
                        <label><input type="radio" name="stream" @if ($torrent->stream == 1) checked @endif value="1">@lang('common.yes')</label>
                    </div>
                    <div class="radio-inline">
                        <label><input type="radio" name="stream" @if ($torrent->stream == 0) checked @endif value="0">@lang('common.no')</label>
                    </div>
                    <br>
                    <br>
                    <label for="hidden" class="control-label">@lang('torrent.sd-content')?</label>
                    <div class="radio-inline">
                        <label><input type="radio" name="sd" @if ($torrent->sd == 1) checked @endif value="1">@lang('common.yes')</label>
                    </div>
                    <div class="radio-inline">
                        <label><input type="radio" name="sd" @if ($torrent->sd == 0) checked @endif value="0">@lang('common.no')</label>
                    </div>
                    <br>
                    <br>
                    @if (auth()->user()->group->is_modo || auth()->user()->group->is_internal)
                        ...
                        <div class="radio-inline">
                            <label><input type="radio" name="internal" @if ($torrent->internal == 1) checked @endif value="1">@lang('common.yes')</label>
                        </div>
                        <div class="radio-inline">
                            <label><input type="radio" name="internal" @if ($torrent->internal == 0) checked @endif value="0">@lang('common.no')</label>
                        </div>
                        <br>
                        <br>
                    @else
                    ...
                    @if (auth()->user()->group->is_modo || auth()->user()->id === $torrent->user_id)
                        ...
                        <div class="radio-inline">
                            <label><input type="radio" name="personal_release" @if ($torrent->personal_release == 1) checked @endif
                                    value="1">@lang('common.yes')</label>
                        </div>
                        <div class="radio-inline">
                            <label><input type="radio" name="personal_release" @if ($torrent->personal_release == 0) checked @endif
