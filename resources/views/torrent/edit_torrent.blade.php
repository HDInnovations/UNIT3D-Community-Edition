        ...
        <div class="col-md-10">
            ...
            <div class="block">
                <form role="form" method="POST" action="{{ route('edit', ['id' => $torrent->id]) }}"
                    ...
                    @if ($torrent->category->tv_meta)
                        <div class="form-group">
                            <label for="season_number">@lang('torrent.season-number') <b>(@lang('common.required') For
                                    TV)</b></label>
                    ...
                    @if ($torrent->category->tv_meta)
                        <div class="form-group">
                            <label for="episode_number">@lang('torrent.episode-number') <b>(@lang('common.required') For
