...
@section('content')
    ...
    <div class="container box">
      ...
      <label class="inline">
          {{ Form::checkbox('freeleech','1',false,['id'=>'freeleech']) }} <span class="fa fa-star text-gold"></span> 100% Free
                ...
                <span class="badge-user">
      <label class="inline">
          {{ Form::checkbox('doubleupload','1',false,['id'=>'doubleupload']) }} <span
                  class="fa fa-diamond text-green"></span> Double Upload
      </label>
      </span>
                <span class="badge-user">
      <label class="inline">
          {{ Form::checkbox('featured','1',false,['id'=>'featured']) }} <span
                  class="fa fa-certificate text-pink"></span> Featured Torrent
      </label>
      </span>
            </div>
        </div>
        ...
        <label class="inline">
            {{ Form::checkbox('stream','1',false,['id'=>'stream']) }} <span class="fa fa-play text-red"></span> Stream Optimized
                ...
                <span class="badge-user">
        <label class="inline">
            {{ Form::checkbox('highspeed','1',false,['id'=>'highspeed']) }} <span
                    class="fa fa-tachometer text-red"></span> High Speeds
        </label>
        </span>
                <span class="badge-user">
        <label class="inline">
        ...
        <div style="float:left;">
            <strong>Extra:</strong>
            <a href="{{ route('categories') }}" class="btn btn-xs btn-primary"><em class="icon fa fa-file"></em>
                Torrent Categories</a>
            <a href="{{ route('catalogs') }}" class="btn btn-xs btn-primary"><em class="icon fa fa-book"></em> Torrent Catalogs</a>
        </div>
        <div style="float:right;">
            <strong>View:</strong>
            <a href="{{ route('torrents') }}" class="btn btn-xs btn-primary"><i class="fa fa-list"></i> Torrent List</a>
            <a href="{{ route('cards') }}" class="btn btn-xs btn-primary"><i class="fa fa-image"></i> Torrent Cards</a>
            <a href="{{ route('grouping_categories') }}" class="btn btn-xs btn-primary"><i class="fa fa-list"></i> Torrent Grouping</a>
        </div>
    </div>
    <!-- /Search -->
    ...
    <div class="container-fluid">
        <div class="block" style="padding-bottom:50px;">
            <div style="float:left;">
                <strong>Stats:</strong>
                <span class="label label-primary text-bold"><i class="fa fa-file-o"></i> {{ $torrents->count() }}
                    Torrents</span>
            ...
            <div style="float:right;">
                ...
                <button class='btn btn-success btn-circle' type='button' data-toggle='tooltip' title=''
                        data-original-title='Currently Seeding!'><i class='fa fa-arrow-up'></i></button>
                <button class='btn btn-warning btn-circle' type='button' data-toggle='tooltip' title=''
                        data-original-title='Currently Leeching!'><i class='fa fa-arrow-down'></i></button>
                <button class='btn btn-info btn-circle' type='button' data-toggle='tooltip' title=''
                        data-original-title='Started Downloading But Never Completed!'><i
                            class='fa fa-hand-paper-o'></i></button>
                <button class='btn btn-danger btn-circle' type='button' data-toggle='tooltip' title=''
                        data-original-title='You Completed This Download But Are No Longer Seeding It!'><i
