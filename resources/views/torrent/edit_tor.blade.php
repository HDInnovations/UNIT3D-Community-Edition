            ...
            <div class="block">
                ...
                <div class="form-group">
                    ...
                    <select name="category_id" class="form-control">
                        <option value="{{ $tor->category->id }}" selected>{{ $tor->category->name  }}
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control">
                        <option value="{{ $tor->type }}" selected>{{ $tor->type  }} ({{ trans('torrent.current') }})
                        </option>
                ...
                <div class="form-group">
                    ...
                    <textarea id="upload-form-description" name="description" cols="30" rows="10"
                              class="form-control">{{ $tor->description }}</textarea>
                </div>
                ...
                <div class="radio-inline">
                    <label><input type="radio" name="anonymous" @if($tor->anon == 1) checked
                                  @endif value="1">{{ trans('common.yes') }}</label>
                </div>
                <div class="radio-inline">
                    <label><input type="radio" name="anonymous" @if($tor->anon == 0) checked
                ...
                <div class="radio-inline">
                    <label><input type="radio" name="stream" @if($tor->stream == 1) checked
                                  @endif value="1">{{ trans('common.yes') }}</label>
                </div>
                <div class="radio-inline">
                    <label><input type="radio" name="stream" @if($tor->stream == 0) checked
                                  @endif value="0">{{ trans('common.no') }}</label>
                </div>
                <br>
                <br>
                ...
                <div class="radio-inline">
                    <label><input type="radio" name="sd" @if($tor->sd == 1) checked
                                  @endif value="1">{{ trans('common.yes') }}</label>
                </div>
                <div class="radio-inline">
                    <label><input type="radio" name="sd" @if($tor->sd == 0) checked
                                  @endif value="0">{{ trans('common.no') }}</label>
                </div>
                <br>
                <br>
