                ...
                <form name="upload" class="upload-form" id="upload-form" method="POST" action="{{ route('upload') }}"
                    ...
                    <div class="radio-inline">
                        <label><input type="radio" name="anonymous"
                                      value="1"{{ old('anonymous') ? ' checked' : '' }}>@lang('common.yes')</label>
                    </div>
                    <div class="radio-inline">
                        <label><input type="radio" name="anonymous"
                                      value="0"{{ !old('anonymous') ? ' checked' : '' }}>@lang('common.no')</label>
                    </div>
                    ...
                    @if ($data->movie_meta || $data->tv_meta)
                        ...
                        <div class="radio-inline">
                            <label><input type="radio" name="stream" id="stream"
                                          value="1"{{ old('stream') ? ' checked' : '' }}>@lang('common.yes')</label>
                        </div>
                        <div class="radio-inline">
                            <label><input type="radio" name="stream" id="stream"
                                          value="0"{{ !old('stream') ? ' checked' : '' }}>@lang('common.no')</label>
                        </div>
                        ...
                        <div class="radio-inline">
                            <label><input type="radio" name="sd"
                                          value="1"{{ old('sd') ? ' checked' : '' }}>@lang('common.yes')</label>
                        </div>
                        <div class="radio-inline">
                            <label><input type="radio" name="sd"
                                          value="0"{{ !old('sd') ? ' checked' : '' }}>@lang('common.no')</label>
                        </div>
                    @else
                    ...
                    @if (auth()->user()->group->is_modo || auth()->user()->group->is_internal)
                        ...
                        <div class="radio-inline">
                            <label><input type="radio" name="internal"
                                          value="1"{{ old('internal') ? ' checked' : '' }}>@lang('common.yes')</label>
                        </div>
                        <div class="radio-inline">
                            <label><input type="radio" name="internal"
                                          value="0"{{ !old('internal') ? ' checked' : '' }}>@lang('common.no')</label>
                        </div>
                    ...
                    <div class="radio-inline">
                        <label><input type="radio" name="personal_release"
                                      value="1"{{ old('personal_release') ? ' checked' : '' }}>@lang('common.yes')
                        </label>
                    </div>
                    <div class="radio-inline">
                        <label><input type="radio" name="personal_release"
                                      value="0"{{ !old('personal_release') ? ' checked' : '' }}>@lang('common.no')
                        </label>
                    </div>
                    ...
                    @if (auth()->user()->group->is_modo || auth()->user()->group->is_internal)
                        ...
                        <div class="radio-inline">
                            <label><input type="radio" name="free"
                                          value="0"{{ !old('free') ? ' checked' : '' }}>@lang('common.no')</label>
                        </div>
                    @else
