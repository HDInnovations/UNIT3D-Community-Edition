<div class="movie-wrapper">
    ...
    <div class="meta-info">
        ...
        <div class="movie-backdrop"
            style="background-image: url('{{ isset($meta) && $meta->artworks ? 'https://images.igdb.com/igdb/image/upload/t_screenshot_big/' . $meta->artworks[0]['image_id'] . '.jpg' : 'https://via.placeholder.com/960x540' }}');">
        </div>
