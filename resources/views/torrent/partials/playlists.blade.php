				...
				@forelse($torrent->playlists as $base)
					<div class="col-md-2">
						<a href="{{ route('playlists.show', ['id' => $base->playlist->id]) }}">
							<div class="item-playlist-container-playlist" style="margin-bottom: 0 !important; min-height: 0 !important;">
								...
								<div class="item-playlist-text-playlist">
									...
									@else
										<img src="{{ url('img/profile.png') }}" alt="{{ $base->playlist->user->username }}">
									@endif
									<h3 class="text-bold" style="margin: 0; color: #cccccc;">{{ $base->playlist->name }}</h3>
									<h5>
