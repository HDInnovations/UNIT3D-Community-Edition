    ...
    <div class="panel-heading">
        <h4>
            ...
            <a href="{{ route('subtitles.create', ['torrent_id' => $torrent->id]) }}" class="btn btn-xs btn-primary"
                style="float: right;" title="@lang('common.add') @lang('common.subtitle')">@lang('common.add')
                @lang('common.subtitle')</a>
        </h4>
    </div>
                        ...
                        <td>
                            ...
                            @if (auth()->user()->group->is_modo || auth()->user()->id == $subtitle->user->id)
                                <div class="align-right" style="display: inline-block;">
                                    @include('subtitle.modals', ['subtitle' => $subtitle, 'torrent' => $torrent,
                                    'media_languages' => App\Models\MediaLanguage::all()->sortBy('name')])
