                        ...
                        @else
                            ...
                            <span class="badge-user text-bold"
                                ...
                                <i class="{{ $subtitle->user->primaryRole->icon }}" data-toggle="tooltip"
                                   data-original-title="{{ $subtitle->user->primaryRole->name }}"></i> {{ $subtitle->user->username }}
                            </span>
                            </a>
                        @endif

                        @if(auth()->user()->hasPrivilegeTo('subtitle_can_update') ||
                            auth()->user()->hasPrivilegeTo('subtitle_can_delete') ||
                            auth()->user()->id == $subtitle->user->id)
                            <div class="align-right" style="display: inline-block;">
                                ...
                                @endif
                                @if(auth()->user()->hasPrivilegeTo('subtitle_can_delete'))
