<ul class="torrent__tags">
    ...
    <li class="torrent__seeders">
        <a class="torrent__seeders-link text-green" href="{{ route('peers', ['id' => $torrent->id]) }}" title="{{ $torrent->seeders }} {{ __('torrent.seeders') }}">
            <i class="{{ config('other.font-awesome') }} fa-arrow-up"></i>
            {{ $torrent->seeders }}
        </a>
    </li>
    <li class="torrent__leechers">
        <a class="torrent__leechers-link text-red" href="{{ route('peers', ['id' => $torrent->id]) }}" title="{{ $torrent->leechers }} {{ __('torrent.leechers') }}">
            <i class="{{ config('other.font-awesome') }} fa-arrow-down"></i>
            {{ $torrent->leechers }}
        </a>
    </li>
    <li class="torrent__completed">
        <a class="torrent__completed-link text-info" href="{{ route('history', ['id' => $torrent->id]) }}" title="{{ $torrent->times_completed }} {{ __('torrent.times') }}">
