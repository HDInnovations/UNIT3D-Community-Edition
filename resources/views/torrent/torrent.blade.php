                                    ...
                                    <div style="margin: 4px 0">
                                        ...
                                        <div class="torrent-discounts" style="display: inline-block">
                                            ...
                                            @if ($torrent->featured == '0')
                                                @if ($freeleech_token || $user->group->is_freeleech == '1' || $personal_freeleech || $torrent->free == '1' || $torrent->promo50 == '1' || $torrent->promo25 == '1' || config('other.freeleech') == '1' || $torrent->doubleup == '1' || $user->group->is_double_upload == '1' || config('other.doubleup') == '1')
                                                    @if ($freeleech_token || $user->group->is_freeleech == '1' || $personal_freeleech || $torrent->free == '1' || config('other.freeleech') == '1')
                                                        <span class="badge-extra" data-toggle="tooltip" data-html="true" title="
                                                            ...
                                                            @if (($torrent->promo50 == '1'))
                                                                <p>50% @lang('torrent.freeleech')</p>
                                                            @endif

                                                            @if (($torrent->promo25 == '1'))
                                                                <p>25% @lang('torrent.freeleech')</p>
                                                            @endif
                                                    ...
                                                    @elseif (($torrent->promo50 == '1'))
                                                        <span class="badge-extra" data-toggle="tooltip" data-html="true" title="
                                                            ...
                                                            "
                                                        >
                                                            <i class="{{ config('other.font-awesome') }} fa-star-half-alt text-gold"></i>
                                                        </span>
                                                    @elseif ($torrent->promo25 == '1')
                                                        <style>
                                                            .star {position: relative;}
                                                            .star:after {content: "\f005";position: absolute;left: 0;top: 0;width: 30%;overflow: hidden;color: #f39c12;}
                                                        </style>
                                                        <span class="badge-extra" data-toggle="tooltip" data-html="true" title="
                                                            ...
                                                            "
                                                        >
                                                            <i class="star {{ config('other.font-awesome') }} fa-star"></i>
                                                        </span>
                                                    @endif
                    ...
                    <table class="table table-condensed table-bordered table-striped">
                        ...
                        @if ($torrent->featured == '0')
                            <tr class="success torrent-discounts">
                                ...
                                <td>
                                    @if ($torrent->doubleup == '1' || $torrent->free == '1' || $torrent->promo50 == '1' || $torrent->promo25 == '1' || config('other.freeleech') == '1' || config('other.doubleup') == '1' || $personal_freeleech || $user->group->is_freeleech == '1' || $freeleech_token)
                                        @if (config('other.freeleech') == '1')
                                        ...
                                        @if ($torrent->promo50 == '1')
                                            <span class="badge-extra text-bold">
                                                <i class="{{ config('other.font-awesome') }} fa-star-half-alt text-gold"></i> 50% @lang('common.free')
                                            </span>
                                        @endif
                                        ...
                                        @if ($torrent->promo25 == '1')
                                            ...
                                            <span class="badge-extra text-bold">
                                                <i class="star {{ config('other.font-awesome') }} fa-star">
                                                </i> 25% @lang('common.free')
                                            </span>
                                        @endif
                                        ...
                                        @if (auth()->user()->group->is_modo || auth()->user()->group->is_internal)
                                            <div class="torrent-internal-controls">
                                                <div style="margin-bottom: 10px;">
                                                    @if ($torrent->free == 0 && $torrent->promo50 == 0 && $torrent->promo25 == 0)
                                                        <a href="{{ route('torrent_fl', ['id' => $torrent->id]) }}"
                                                        class="btn btn-success btn-xs" role="button" data-toggle="tooltip" data-original-title="100% Free">
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.grant') @lang('torrent.freeleech')
                                                        </a>
                                                    @elseif ($torrent->featured || $torrent->promo50 == 1 || $torrent->promo25 == 1)
                                                        <a href="#"
                                                        class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-original-title="Another Promo is already active!"
                                                        disabled>
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.revoke') @lang('torrent.freeleech')
                                                        </a>
                                                    @else
                                                        <a href="{{ route('torrent_fl', ['id' => $torrent->id]) }}"
                                                        class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-original-title="100% Free">
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.revoke') @lang('torrent.freeleech')
                                                        </a>
                                                    @endif

                                                    @if ($torrent->promo50 == 0 && $torrent->free == 0 && $torrent->promo25 == 0)
                                                        <a href="{{ route('torrent_promo50', ['id' => $torrent->id]) }}"
                                                        class="btn btn-success btn-xs" role="button" data-toggle="tooltip" data-original-title="50% @lang('common.free')">
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.grant') 50% @lang('common.free')
                                                        </a>
                                                        @elseif ($torrent->featured || $torrent->free == 1 || $torrent->promo25 == 1)
                                                        <a href="#"
                                                        class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-original-title="Another Promo is already active!"
                                                        disabled>
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.revoke') 50% @lang('common.free')
                                                        </a>
                                                    @else
                                                        <a href="{{ route('torrent_promo50', ['id' => $torrent->id]) }}"
                                                        class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-original-title="50% @lang('common.free')">
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.revoke') 50% @lang('common.free')
                                                        </a>
                                                    @endif

                                                    @if ($torrent->promo25 == 0 && $torrent->free == 0 && $torrent->promo50 == 0)
                                                        <a href="{{ route('torrent_promo25', ['id' => $torrent->id]) }}"
                                                        class="btn btn-success btn-xs" role="button" data-toggle="tooltip" data-original-title="25% @lang('common.free')">
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.grant') 25% @lang('common.free')
                                                        </a>
                                                        @elseif ($torrent->featured || $torrent->free == 1 || $torrent->promo50 == 1)
                                                        <a href="#"
                                                        class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-original-title="Another Promo is already active!"
                                                        disabled>
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.revoke') 25% @lang('common.free')
                                                        </a>
                                                    @else
                                                        <a href="{{ route('torrent_promo25', ['id' => $torrent->id]) }}"
                                                        class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-original-title="25% @lang('common.free')">
                                                            <i class="{{ config('other.font-awesome') }} fa-star"></i> @lang('torrent.revoke') 25% @lang('common.free')
                                                        </a>
                                                    @endif
                                                </div>
