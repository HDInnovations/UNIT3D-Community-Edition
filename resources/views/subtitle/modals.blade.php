            ...
            <div class="container-fluid">
                <form role="form" method="POST" action="{{ route('subtitles.update', ['id' => $subtitle->id]) }}">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">@lang('common.edit') @lang('common.subtitle') -
                            {{ $torrent->name }}</h4>
                    </div>
...
<div class="modal fade" id="modal_delete_subtitle-{{ $subtitle->id }}" tabindex="-1" role="dialog"
    aria-hidden="true">
    <div class="modal-dialog{{ \modal_style() }}">
        <div class="modal-content">
            <div class="container-fluid">
                <form role="form" method="POST" action="{{ route('subtitles.destroy', ['id' => $subtitle->id]) }}">
                    ...
                    <div class="modal-body text-center">
                        <input class="btn btn-danger" type="submit"
                            value="@lang('common.delete') - {{ $subtitle->language->name }} @lang('common.subtitle')">
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-sm btn-primary" type="button"
                            data-dismiss="modal">@lang('common.close')</button>
