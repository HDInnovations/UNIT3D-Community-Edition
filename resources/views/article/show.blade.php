...
@section('breadcrumb')
    ...
    <li>
        <a href="{{ route('articles.show', ['id' => $article->id]) }}" itemprop="url" class="l-breadcrumb-item-link">
                    ...
                    <div class="panel-body no-padding">
                        <ul class="media-list comments-list">
                            ...
                            @else
                                ...
                                @endif
                                <span
                                    class="text-muted"><small><em>{{ $comment->created_at->diffForHumans() }}</em></small></span>
