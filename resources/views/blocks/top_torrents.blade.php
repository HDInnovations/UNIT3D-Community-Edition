                ...
                <table class="table table-condensed table-striped table-bordered">
                    ...
                    @foreach ($newest as $new)
                        <tr>
                            ...
                            <td>
                                <a class="text-bold"
                                   href="{{ route('torrent', ['slug' => $new->slug, 'id' => $new->id]) }}">
                                    {{ $new->name }}
                                </a>
                                ...
                                @if ($freeleech_token)
                                    <span class='badge-extra text-bold'>
                                            <i class='{{ config("other.font-awesome") }} fa-coins text-bold'
                                               data-toggle='tooltip' title=''
                ...
                <table class="table table-condensed table-striped table-bordered">
                    ...
                    @foreach ($seeded as $seed)
                        <tr>
                            ...
                            <td>
                                <a class="text-bold"
                                   href="{{ route('torrent', ['slug' => $seed->slug, 'id' => $seed->id]) }}">
                                    {{ $seed->name }}
                                </a>
                                @if (config('torrent.download_check_page') == 1)
                ...
                <table class="table table-condensed table-striped table-bordered">
                    ...
                    @foreach ($leeched as $leech)
                        <tr>
                            ...
                            <td>
                                <a class="text-bold"
                                   href="{{ route('torrent', ['slug' => $leech->slug, 'id' => $leech->id]) }}">
                                    {{ $leech->name }}
                                </a>
                                @if (config('torrent.download_check_page') == 1)
