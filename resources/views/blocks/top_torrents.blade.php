                                ...
                                <tr>
                                    <td style="width: 1%;">
                                        ...
                                        @else
                                            <a href="{{ route('categories.show', ['id' => $new->category->id]) }}">
                                                <div class="text-center">
                                                    <i class="{{ $new->category->icon }} torrent-icon"
                                                        data-toggle="tooltip"
                                    ...
                                    <td>
                                        ...
                                        <span data-toggle="tooltip" data-original-title="@lang('torrent.bookmark')"
                                            ...
                                            id="newTorrentBookmark{{ $new->id }}" torrent="{{ $new->id }}"
                                        ...
                                        @if ($new->anon == 1)
                                            <span class="badge-extra text-bold">
                                                <i class="{{ config('other.font-awesome') }} fa-upload"
                                                    data-toggle="tooltip" data-original-title="Uploaded By"></i>
                                                @lang('common.anonymous')
                                                @if ($user->id == $new->user->id || $user->group->is_modo)
                                                    <a
                                                        href="{{ route('users.show', ['username' => $new->user->username]) }}">
                                                        ({{ $new->user->username }})
                                                    </a>
                                                @endif
                                            </span>
                                        @else
                                            <span class="badge-extra text-bold">
                                                <i class="{{ config('other.font-awesome') }} fa-upload"
                                                    data-toggle="tooltip" data-original-title="Uploaded By"></i> By
                                                <a
                                                    href="{{ route('users.show', ['username' => $new->user->username]) }}">
                                                    {{ $new->user->username }}
                                                </a>
                                        ...
                                        <span class="badge-extra text-bold text-pink">
                                            <i class="{{ config('other.font-awesome') }} fa-heart"
                                                data-toggle="tooltip" data-original-title="Thanks Given"></i>
                                            {{ $new->thanks_count }}
                                        </span>

                                        <span class="badge-extra text-bold text-green">
                                            <i class="{{ config('other.font-awesome') }} fa-comment"
                                                data-toggle="tooltip" data-original-title="Comments Left"></i>
                                            {{ $new->comments_count }}
                                        </span>
                                        ...
                                        @if ($new->internal == 1)
                                            <span class='badge-extra text-bold'>
                                                <i class='{{ config('other.font-awesome') }} fa-magic'
                                                    ...
                                                    data-original-title='Internal Release' style="color: #baaf92;"></i>
                                                Internal
                                            </span>
                                        @endif
                                        ...
                                        @if ($personal_freeleech)
                                            <span class='badge-extra text-bold'>
                                                <i class='{{ config('other.font-awesome') }} fa-id-badge text-orange'
                                                    data-toggle='tooltip' title=''
                                                    data-original-title='Personal FL'></i>
                                                Personal FL
                                            </span>
                                        @endif
                                        ...
                                        @if ($user->group->is_double_upload == 1)
                                            <span class='badge-extra text-bold'>
                                                ...
                                                @lang('torrent.special-double_upload')
                                            </span>
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span data-toggle="tooltip" data-original-title="@lang('torrent.bookmark')"
                                            ...
                                            id="seededTorrentBookmark{{ $seed->id }}"
                                            torrent="{{ $seed->id }}"
                                        ...
                                        @if ($seed->anon == 1)
                                            <span class="badge-extra text-bold">
                                                ...
                                                @if ($user->id == $seed->user->id || $user->group->is_modo)
                                                    <a
                                                        href="{{ route('users.show', ['username' => $seed->user->username]) }}">
                                                        ({{ $seed->user->username }})
                                                    </a>
                                                @endif
                                            </span>
                                ...
                                <tr>
                                    <td style="width: 1%;">
                                        @if ($leech->category->image != null)
                                            <a
                                                href="{{ route('categories.show', ['id' => $leech->category->id]) }}">
                                                <div class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <span data-toggle="tooltip" data-original-title="@lang('torrent.bookmark')"
                                            ...
                                            id="leechedTorrentBookmark{{ $leech->id }}"
                                            torrent="{{ $leech->id }}"
                                        ...
                                        @if ($leech->anon == 1)
                                            <span class="badge-extra text-bold">
                                                ...
                                                @if ($user->id == $leech->user->id || $user->group->is_modo)
                                                    <a
                                                        href="{{ route('users.show', ['username' => $leech->user->username]) }}">
                                                        ({{ $leech->user->username }})
                                                    </a>
                                                @endif
                                            </span>
                                            ...
                                            <a href="{{ route('categories.show', ['id' => $d->category->id]) }}">
                                                <div class="text-center">
                                                    <i class="{{ $d->category->icon }} torrent-icon"
                                                        data-toggle="tooltip"
                                                        data-original-title="{{ $d->category->name }} {{ strtolower(trans('torrent.torrent')) }}"></i>
                                                </div>
                                            </a>
                                        @endif
                                    </td>
                                        ...
                                        @if ($d->anon == 1)
                                            <span class="badge-extra text-bold">
                                                ...
                                                @if ($user->id == $d->user->id || $user->group->is_modo)
                                                    <a
                                                        href="{{ route('users.show', ['username' => $d->user->username]) }}">
                                                        ({{ $d->user->username }})
                                                    </a>
                                                @endif
                                            </span>
                            ...
                            @foreach ($dead as $d)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span data-toggle="tooltip" data-original-title="@lang('torrent.bookmark')"
                                            custom="deadTorrentBookmark{{ $d->id }}"
                                            id="deadTorrentBookmark{{ $d->id }}"
                                            torrent="{{ $d->id }}"
                                            state="{{ $bookmarks->where('torrent_id', $d->id)->count() ? 1 : 0 }}"
                                            class="torrentBookmark"></span>
