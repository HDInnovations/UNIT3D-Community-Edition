<div class="col-md-10 col-sm-10 col-md-offset-1">
    ...
    <div class="panel panel-chat shoutbox">
        <div class="panel-heading">
            <h4><i class="{{ config('other.font-awesome') }} fa-trophy-alt"></i> @lang('user.top-uploaders-count')
            </h4>
        </div>
                                ...
                                <tr>
                                        ...
                                        @else
                                            <a
                                                ...
                                                <span class="badge-user text-bold"
                                                    ...
                                                    <i class="{{ $uploader->user->group->icon }}"
                                                        data-toggle="tooltip"
                                    ...
                                    <td>
                                        <span class="text-bold"><i
                                            ...
                                            {{ App\Helpers\StringHelper::ordinal(++$key) }}
                                            @lang('stat.place')</span>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        <tbody>
                            @foreach ($past_uploaders as $key => $past_uploader)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="text-green">{{ $past_uploader->user->getLast30Uploads() }}</span>
                                    </td>
                                    <td>
                                        <span class="text-bold"><i
                                                class="{{ config('other.font-awesome') }} fa-ribbon"></i>
