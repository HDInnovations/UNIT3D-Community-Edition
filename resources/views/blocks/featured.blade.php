            ...
            <div id="myCarousel" class="keen-slider">
                ...
                @foreach ($featured as $key => $feature)
                    ...
                    <div class="keen-slider__slide">
                        <div class="movie-image">
                            <img class="backdrop" src=@if ($feature->torrent->category->tv_meta || $feature->torrent->category->movie_meta) "{{ isset($meta->backdrop) ? \tmdb_image('back_small', $meta->backdrop) : 'https://via.placeholder.com/533x300' }}">
                        ...
                        @else
                                "{{ 'https://via.placeholder.com/533x300' }}"> @endif <div
                                class="fade-img">
                        </div>
                    </div>
                    <div class="movie-card">
