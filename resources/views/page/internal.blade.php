...
<li>
    <a href="{{ route('internal') }}" itemprop="url" class="l-breadcrumb-item-link">
        <span itemprop="title" class="l-breadcrumb-item-link-title">{{ Config::get('other.title') }} {{ trans('common.internal') }}</span>
    </a>
</li>
@stop
	...
	<div class="col-md-12 page">
		<div class="header gradient silver">
			<div class="inner_content">
				<div class="page-title"><h1>{{ Config::get('other.title') }} {{ trans('common.internal') }}</h1></div>
			</div>
		</div>
