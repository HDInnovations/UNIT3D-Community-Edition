...
@section('breadcrumb')
    <li>
        <a href="{{ route('client_blacklist') }}" itemprop="url" class="l-breadcrumb-item-link">
            <span itemprop="title" class="l-breadcrumb-item-link-title">{{ config('other.title') }} {{ __('common.blacklist') }}</span>
        </a>
    </li>
@endsection
