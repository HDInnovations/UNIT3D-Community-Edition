                ...
                <div class="row">
                                                    ...
                                                    @else
                                                        <td>
                                                            <span class="label label-warning">
                                                                @lang('common.progress'):{{ $item->points }}/{{ $item->details->points }}
                                                            </span>
                                                        </td>
                                                    @endif
                                                </tr>
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            @foreach ($pending as $p)
                                                <tr>
                                                    <td>
                                                        <img src="/img/badges/{{ $p->details->name }}.png"
                                                             alt="{{ $p->details->name }}" data-toggle="tooltip"
                                                             data-original-title="{{ $p->details->name }}">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="label label-warning">
                                                            @lang('common.progress'):{{ $p->points }}/{{ $p->details->points }}
                                                        </span>
                    ...
                    <div class="col-sm-2 text-center">
                        ...
                        <div class="text-red well well-sm">
                            <h3>
                                <strong>@lang('user.locked-achievements'):</strong>
