    ...
    <div class="block">
        <ul class="nav nav-list">
            ...
            <li><a href="{{ route('staff_dashboard') }}"><i
                            class="fa fa-columns"></i> {{ trans('staff.staff-dashboard') }}</a></li>
            ...
            @if(auth()->user()->group->is_admin)
                ...
                <li><a href="{{ route('staff_groups_index') }}"><i class="fa fa-users"></i> {{ trans('staff.groups') }}
                    </a></li>
            @endif
            ...
            <li><a href="{{ route('staff_torrent_index') }}"><i
                            class="fa fa-file-movie-o"></i> {{ trans('staff.torrents') }}</a></li>
            <li><a href="{{ route('staff_category_index') }}"><i
                            class="fa fa-columns"></i> {{ trans('staff.torrent-categories') }}</a></li>
            <li><a href="{{ route('staff_type_index') }}"><i
                            class="fa fa-columns"></i> {{ trans('staff.torrent-types') }}</a></li>
            <li><a href="{{ route('getCatalog') }}"><i class="fa fa-book"></i> {{ trans('staff.catalog-groups') }}</a>
            </li>
            <li><a href="{{ route('getCatalogTorrent') }}"><i
                            class="fa fa-book"></i> {{ trans('staff.catalog-torrents') }}</a></li>
            <li><a href="{{ route('flush') }}"><i
                            class="fa fa-snapchat-ghost"></i> {{ trans('staff.flush-ghost-peers') }}</a></li>
            <li><a href="{{ route('moderation') }}"><i
                            class="fa fa-columns"></i> {{ trans('staff.torrent-moderation') }}</a></li>
            ...
            <li><a href="{{ route('getWarnings') }}"><i class="fa fa-file"></i> {{ trans('staff.warnings-log') }}</a>
            </li>
        </ul>
    </div>
</div>
