<div class="ratio-bar">
    <div class="container-fluid">
        <ul class="list-inline">
                   ...
                   class="l-header-user-data-link">
                    <span class="badge-user"
                          style="color:{{ auth()->user()->group->color }}"><strong>{{ auth()->user()->username }}</strong>@if(auth()->user()->getWarning() > 0)
                            <i class="fa fa-exclamation-circle text-orange" aria-hidden="true" data-toggle="tooltip"
            ...
            <li><i class="fa fa-arrow-up text-green text-bold"></i> {{ trans('common.upload') }}
                : {{ auth()->user()->getUploaded() }}</li>
            <li><i class="fa fa-arrow-down text-red text-bold"></i> {{ trans('common.download') }}
                : {{ auth()->user()->getDownloaded() }}</li>
            <li><i class="fa fa-signal text-blue text-bold"></i> {{ trans('common.ratio') }}
