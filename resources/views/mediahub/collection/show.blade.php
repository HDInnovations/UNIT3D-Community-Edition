    ...
    <div class="torrent box container single">
        <div class="movie-wrapper">
            ...
            <div class="movie-poster">
                <img src="{{ $collection->poster ? \tmdb_image('poster_big', $collection->poster) : 'https://via.placeholder.com/400x600' }}"
            ...
            <div class="meta-info">
                ...
                <div class="movie-backdrop"
                    style="background-image: url('{{ $collection->backdrop ? \tmdb_image('back_big', $collection->backdrop) : 'https://via.placeholder.com/960x540' }}');">
                </div>
                                    ...
                                    @foreach ($collection->movie as $movie)
                                        <div class="item mini backdrop mini_card col-md-3">
                                            <div class="image_content">
                                                ...
                                                @endphp
                                                <a
                                                    href="{{ route('torrents.similar', ['category_id' => $torrent_temp->category_id, 'tmdb' => $movie->id]) }}">
                                                    <div>
                                                        <img class="backdrop"
                                                            src="{{ \tmdb_image('poster_mid', $movie->poster) }}">
                                                    </div>
                                                    <div style=" margin-top: 8px;">
                                                        <span class="badge-extra"><i
                                                                class="fas fa-calendar text-purple"></i>
                                                            @lang('common.year'):
                                                            {{ substr($movie->release_date, 0, 4) }}</span>
                                                        <span class="badge-extra"><i class="fas fa-star text-gold"></i>
                                                            @lang('torrent.rating'): {{ $movie->vote_average }}</span>
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
