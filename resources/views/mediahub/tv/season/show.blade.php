                    ...
                    <div class="inner_content">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1414 300">
                                <path class="cls-1"
                                    d="M531.37,223.71a15.76,15.76,0,0,0,3.15-22.07h0a15.76,15.76,0,0,0-22.07-3.15l-38.92,29.2a15.74,15.74,0,0,1-18.67-24.88L541,138.15a15.76,15.76,0,0,0-18.92-25.21L272.84,300H440.4A15.77,15.77,0,0,1,445,288.6l-.34.2Z">
                                </path>
                                <path class="cls-1"
                        ...
                        <a href="{{ route('mediahub.shows.show', ['id' => $show->id]) }}">
                            ...
                            <h3
                                style="z-index: 1; position: relative; font-size:20px; margin: 0; text-decoration: underline ;">
                            ...
                            <div class="card is-torrent" style="margin-top: 0; margin-bottom: 20px; height: auto;">
                                ...
                                <div class="card_body">
                                    <div class="body_poster">
                                        <img src="{{ isset($episode->still) ? \tmdb_image('still_mid', $episode->still) : 'https://via.placeholder.com/400x225' }}"
                                            class="show-poster">
                                    </div>
