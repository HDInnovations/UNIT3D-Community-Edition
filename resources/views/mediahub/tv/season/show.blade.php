...
@section('breadcrumb')
    ...
    <li class="active">
        <a href="{{ route('mediahub.season.show', ['id' => $season->id]) }}" itemprop="url" class="l-breadcrumb-item-link">
