                ...
                <div class="footer">
                    <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                @section('footer')
                                    ...
                                    <a href="{{ url('email/unsubscribe?email='.$to) }}">
                        ...
                        <tr>
                            <td>
                                @section('disclaimer')
                                    This is a service email for <span
                                            style="color: #2F90E2; text-decoration: none;">{{ $to }}</span> containing
                                    necessary account information.<br>Please do not reply to this message.<br><span
                                            class="apple-link"><a
                                                href="{{ url('/') }}">{{ env('SITE_NAME') }}</a></span>
                                @show
                            </td>
                        </tr>
                    </table>
