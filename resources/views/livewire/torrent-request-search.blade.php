            ...
            <div class="mt-5">
                <div class="row">
                    <div class="form-group col-xs-9">
                        <input wire:model="name" type="search" class="form-control"
                ...
                <div x-show="open">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-xs-6">
                            ...
                            @foreach (App\Models\Category::select(['id', 'name', 'position'])->get()->sortBy('position')
    as $category)
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-xs-6">
                            ...
                            @foreach (App\Models\Type::select(['id', 'name', 'position'])->get()->sortBy('position')
    as $type)
                                <span class="badge-user">
                                    <label class="inline">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-xs-6">
                            ...
                            @foreach (App\Models\Resolution::select(['id', 'name', 'position'])->get()->sortBy('position')
    as $resolution)
                                <span class="badge-user">
                                    <label class="inline">
