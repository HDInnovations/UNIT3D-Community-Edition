<div style="display: flex; flex-direction: column; row-gap: 1rem;">
        ...
        <div class="panel__body" style="padding: 5px;">
            <form class="form">
                <div class="form__group--short-horizontal">
                    <p class="form__group">
                        <input id="torrent" wire:model.live="torrent" class="form__text" placeholder=" ">
                    ...
                    <p class="form__group">
                        <select id="connectivity" wire:model.live="connectivity" class="form__select" placeholder=" ">
                    ...
                    <p class="form__group">
                        <select id="active" wire:model.live="active" class="form__select" placeholder=" ">
                            <option value="any">Any</option>
                    ...
                    <p class="form__group">
                        <select id="groupBy" wire:model.live="groupBy" class="form__select" placeholder=" ">
    ...
    <section class="panelV2">
        ...
        <div class="data-table-wrapper">
            ...
            {{ $peers->links('partials.livewire-pagination') }}
        </div>
    </section>
</div>
