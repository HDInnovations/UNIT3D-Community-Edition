                ...
                <template x-for="message in messages" :key="message.id">
                    <li>
                        <article class="chatbox-message">
                                ...
                                <figure class="chatbox-message__figure">
                                    ...
                                    >
                                        <img
                                            ...
                                            x-bind:src="users[message.user_id]?.image === null ? '/img/profile.png' : `/files/img/${users[message.user_id].image}`"
                            ...
                            <section class="chatbox-message__content" x-text="message.message"></section>
                        </article>
                    </li>
                </template>
                <template x-if="currentEcho.target_id !== null && Object.keys(messages()).length === 0">
                    <li>You have no conversation history with this user. Send them a message!</li>
                </template>
                <template x-if="currentEcho.room_id !== null && Object.keys(messages()).length === 0">
    ...
    <script nonce="{{ HDVinnie\SecureHeaders\SecureHeaders::nonce('script') }}">
        function chatbox() {
            return {
                ...
                messages() {
                    if (typeof this.channels[this.getWsChannelName(this.currentEcho)] === 'undefined') {
                        return {};
                    }
                ...
                subscribedUserIds() {
                    if (typeof this.subscriptions[this.getWsChannelName(this.currentEcho)] === 'undefined') {
                        return {};
                    }
                ...
                listenToEcho(echo) {
                    ...
                    window.Echo
                        ...
                        .listen('MessageCreated', (e) => {
                            ...
                            if (echo.id !== this.currentEcho.id && e.message.user_id !== this.userId) {
                                Swal.mixin({
                                    toast: true,
                                    position: 'top-end',
                ...
                listenForNewEchoes() {
                    window.Echo
                        .private(`echo.created.${this.userId}`)
                        .listen('EchoCreated', (e) => {
