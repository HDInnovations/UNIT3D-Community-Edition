                ...
                <div x-show="open">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 col-xs-6">
                            ...
                            <span class="badge-user">
                                <label class="inline">
                                    <input wire:model="promo50" type="checkbox" value="1">
                                    50% @lang('common.free')
                                </label>
                            </span>
                            <span class="badge-user">
                                <label class="inline">
                                    <input wire:model="promo25" type="checkbox" value="1">
                                    25% @lang('common.free')
                                </label>
                            </span>
                            <span class="badge-user">
                            ...
                            <td style="vertical-align: middle;" x-data="{ tooltip: false }">
                                ...
                                @if ($torrent->internal == 1)
                                    ...
                                    <i class='{{ config('other.font-awesome') }} fa-magic' data-toggle='tooltip' 
                                        title='' data-original-title='@lang('torrent.internal-release')' style="color: #baaf92;"></i>
                                    </span>
                                @endif
                                ...
                                @if ($torrent->featured == 0)
                                    ...
                                    @if ($torrent->promo50 == '1')
                                        ...
                                        <i class='{{ config('other.font-awesome') }} fa-star-half-alt text-gold' data-toggle='tooltip'
                                            title='' data-original-title='50% @lang('common.free')'></i>
                                        </span>
                                    @endif
                                    @if ($torrent->promo25 == '1')
                                        ...
                                        <span class='badge-extra text-bold torrent-listings-freeleech'>
                                        <i class="star {{ config('other.font-awesome') }} fa-star" data-toggle='tooltip'
                                            title='' data-original-title='25% @lang('common.free')'></i>
                                        </span>
                                    @endif
