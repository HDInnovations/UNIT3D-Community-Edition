<div>
    <div class="container-fluid">
        <div class="block">
            <div
                class="container box search mt-5 fatten-me form-horizontal form-condensed form-torrent-search form-bordered">
                            ...
                            <tr>
                                <td>
                                    @if ($subtitle->torrent->category->image != null)
                                        <a
                                            href="{{ route('categories.show', ['id' => $subtitle->torrent->category->id]) }}">
                                ...
                                <td>
                                    <a class="movie-title"
                                        href="{{ route('torrent', ['id' => $subtitle->torrent->id]) }}">
                                ...
                                <td>
                                    ...
                                    <i class="{{ config('other.font-awesome') }} fa-closed-captioning"
                                        data-toggle="tooltip" data-title="{{ $subtitle->note }}"></i>
                                </td>
                                <td>
                                    ...
                                    @if ($subtitle->anon == true)
                                        <span
                                            ...
                                            @if (auth()->user()->id == $subtitle->user_id || auth()->user()->group->is_modo)
                                                <a
                                                    href="{{ route('users.show', ['username' => $subtitle->user->username]) }}">
