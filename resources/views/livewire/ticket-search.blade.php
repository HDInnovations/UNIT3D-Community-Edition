<div>
    <div class="mb-10 form-inline pull-left">
        <a href="{{ route('tickets.create') }}" class="btn btn-success"><i class="fas fa-plus"></i>
            @lang('ticket.create-ticket')</a>
    </div>
    <div class="mb-10 form-inline pull-left">
                ...
                <tr>
                    ...
                    <th class="hidden-sm hidden-xs">
                        <div sortable wire:click="sortBy('closed_at')"
                            :direction="$sortField === 'closed_at' ? $sortDirection : null" role="button">
                            @lang('common.status')
                ...
                @foreach ($tickets as $ticket)
                    <tr>
                        ...
                        <td>
                            <span>
                                <a
                                    href="{{ route('tickets.show', ['id' => $ticket->id]) }}">{{ $ticket->subject }}</a>
                            </span>
                        ...
                        <td>
                            <span class="badge-user">
                                <a
                                    href="{{ route('users.show', ['username' => $ticket->staff->username ?? 'System']) }}">
