			...
			<div class="collection">
				<div class="header collection" style=" background-image: url({{ $collection->backdrop ?? 'https://via.placeholder.com/1400x800' }}); background-size: cover; background-position: 50% 50%;">
					...
					<section class="collection">
						...
						<a href="{{ route('mediahub.collections.show', ['id' => $collection->id]) }}" role="button" class="btn btn-labeled btn-primary" style=" margin: 0; text-transform: uppercase; position: absolute; bottom: 50px;">
							<span class="btn-label"><i class="{{ config("other.font-awesome") }} fa-copy"></i> View The Collection</span>
						</a>
					</section>
				</div>
			</div>
