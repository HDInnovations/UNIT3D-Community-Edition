        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-chat shoutbox">
                <div class="panel-heading">
                    <h4>{{ config('other.title') }} Application</h4>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <form role="form" method="POST" action="{{ route('add_application') }}">
                        ...
                        <div class="form-group">
                            <button id="addImg" class="btn btn-primary">Add Profile Image</button>
                            <button id="delImg" class="btn btn-primary">Delete Profile Image</button>
                        </div>

                        <hr>

                        <div class="form-group">
                            <label for="link1">Profile Link 1:</label>
                            <input type="text" name="links[]" class="form-control" value="">
                        </div>

                        <div class="form-group">
                            <label for="link2">Profile Link 2:</label>
                            <input type="text" name="links[]" class="form-control" value="">
                        </div>
                        ...
                        <div class="form-group">
                            <button id="addLink" class="btn btn-primary">Add Profile Link</button>
                            <button id="delLink" class="btn btn-primary">Delete Profile Link</button>
                        </div>
...
<script type="text/javascript">
  ...
  $('#addImg').on('click', function (e) {
    e.preventDefault();
    images = images + 1;
    var imageHTML = '<div class="form-group extra-image"><label for="image' + image + '">Image ' + images + ':</label><input type="text" name="images[]" class="form-control" value="" required></div>';
...
<script type="text/javascript">
  ...
  $('#addLink').on('click', function (e) {
    e.preventDefault();
    links = links + 1;
    var linkHTML = '<div class="form-group extra-link"><label for="link' + link + '">Link ' + links + ':</label><input type="text" name="links[]" class="form-control" value="" required></div>';
