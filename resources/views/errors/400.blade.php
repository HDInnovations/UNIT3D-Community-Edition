...
<head>
  <meta charset="utf-8">
  <title>Error 400: Bad Request! - {{ Config::get('other.title') }}</title>
   ...
   <h2>{{ $exception->getMessage() }}</h2>
    <div class="jumbotron shadowed">
      <div class="container">
        ...
        <p class="text-center">The request could not be understood by the server due to malformed syntax. <br>The client SHOULD NOT repeat the request without modifications.</p>
        <p class="text-center">
