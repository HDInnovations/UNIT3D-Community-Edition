...
<head>
    <meta charset="utf-8">
    <title>Error 400: Bad Request! - {{ config('other.title') }}</title>
    ...
    <div class="jumbotron shadowed">
        <div class="container">
            <h1 class="mt-5 text-center">
                <i class="fa fa-exclamation-circle text-warning"></i> Error 400: Bad Request!
            </h1>
            <div class="separator"></div>
            <p class="text-center">The request could not be understood by the server due to malformed syntax. <br>The
