...
<head>
    <meta charset="utf-8">
    <title>Error 503: Service Unavailable! - {{ config('other.title') }}</title>
...
<section class="container content" id="content-area" style="min-height: 344px;">
    <div class="jumbotron shadowed">
        <div class="container">
            ...
            <p class="text-center">The server is currently unavailable (because it is overloaded or down for
