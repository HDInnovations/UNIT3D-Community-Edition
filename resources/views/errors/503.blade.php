...
<head>
  <meta charset="utf-8">
  <title>Error 503: Service Unavailable! - {{ Config::get('other.title') }}</title>
   ...
   <h2>{{ $exception->getMessage() }}</h2>
    <div class="jumbotron shadowed">
      <div class="container">
        ...
        <p class="text-center">The server is currently unavailable (because it is overloaded or down for maintenance). Generally, this is a temporary state.</p>
        <p class="text-center">
