...
<head>
  <meta charset="utf-8">
  <title>Error 502: Bad Gateway! - {{ Config::get('other.title') }}</title>
   ...
   <h2>{{ $exception->getMessage() }}</h2>
    <div class="jumbotron shadowed">
      <div class="container">
        ...
        <p class="text-center">The server, while acting as a gateway or proxy, received an invalid response from the upstream server it accessed in attempting to fulfill the request.</p>
        <p class="text-center">
