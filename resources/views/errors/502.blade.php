...
<head>
    <meta charset="utf-8">
    <title>Error 502: Bad Gateway! - {{ config('other.title') }}</title>
...
<section class="container content" id="content-area" style="min-height: 344px;">
    <div class="jumbotron shadowed">
        <div class="container">
            ...
            <p class="text-center">The server, while acting as a gateway or proxy, received an invalid response from the
                upstream server it accessed in attempting to fulfill the request.</p>
            <p class="text-center">
                <a href="{{ url('/') }}" role="button" class="btn btn-labeled btn-primary"><span class="btn-label"><i
                                class="fa fa-home"></i></span>Go Home</a>
            </p>
        </div>
    </div>
</section>
