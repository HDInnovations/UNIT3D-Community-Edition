        ...
        <div class="wrap" id="frameWrap">
            <div class="width-table" style="margin: auto; padding-bottom: 5px; height: 22px;">
                <div class="width-75" style="padding: 0; height: 22px;">
                  ...
                  <div class="typing pull-left" v-if="$parent.target < 1 && $parent.bot < 1 && $parent.activePeer && $parent.activePeer.username != ''" style="padding-left: 0; margin-left: 0; padding-bottom: 0; margin-bottom: 0;">
