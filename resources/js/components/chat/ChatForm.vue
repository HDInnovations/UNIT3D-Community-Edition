    ...
    <div class="message-input">
        <div class="wrap" id="frameWrap">
            <div class="width-table" style="margin: auto; padding-bottom: 5px; height: 22px;">
                <div class="width-25" style="padding-left: 0; margin-left: 0;">
                    <div style="padding-left: 0; margin-left: 0; padding-bottom: 0; margin-bottom: 0;" v-if="$parent.bot > 0 && $parent.activeTab.substr(0,3) == 'bot'">
                        <span class="badge-extra" style="margin-left: 0; padding-left: 5px; margin-bottom: 0;">{{ $parent.botName }} can accept messages from any tab if you type: <strong>/{{ $parent.botCommand }} help</strong></span>
                    </div>
                    <div class="typing" v-if="$parent.target < 1 && $parent.bot < 1 && $parent.activePeer && $parent.activePeer.username != ''" style="padding-left: 0; margin-left: 0; padding-bottom: 0; margin-bottom: 0;">
                        <span class="badge-extra" style="margin-left: 0; padding-left: 5px; margin-bottom: 0;">{{ ($parent.activePeer ? $parent.activePeer.username + ' is typing ...' : '*') }}</span>
                    </div>
                </div>
