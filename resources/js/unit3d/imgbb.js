!function() {
  for(var t= {
    ...
    , classProps:["button", "container"], iconSvg:'<svg class="%iClass" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><path d="M76.7 87.5c12.8 0 23.3-13.3 23.3-29.4 0-13.6-5.2-25.7-15.4-27.5 0 0-3.5-0.7-5.6 1.7 0 0 0.6 9.4-2.9 12.6 0 0 8.7-32.4-23.7-32.4 -29.3 0-22.5 34.5-22.5 34.5 -5-6.4-0.6-19.6-0.6-19.6 -2.5-2.6-6.1-2.5-6.1-2.5C10.9 25 0 39.1 0 54.6c0 15.5 9.3 32.7 29.3 32.7 2 0 6.4 0 11.7 0V68.5h-13l22-22 22 22H59v18.8C68.6 87.4 76.7 87.5 76.7 87.5z"/></svg>', l10n: {
      ar: "تحميل الصور", cs: "Nahrát obrázky", da: "Upload billeder", de: "Bilder hochladen", es: "Subir imágenes", fi: "Lataa kuvia", fr: "Importer des images", id: "Unggah gambar", it: "Carica immagini", ja: "画像をアップロード", nb: "Last opp bilder", nl: "Upload afbeeldingen", pl: "Wyślij obrazy", pt_BR: "Enviar imagens", ru: "Загрузить изображения", tr: "Resim Yukle", uk: "Завантажити зображення", zh_CN: "上传图片", zh_TW: "上傳圖片"
    }
    , vendors: {
      default: {
        check:function() {
        ...
        , getEditor:function() {
          var t= {
              textarea: {
                name: ["mediainfo", "bdinfo", "recaptcha", "search", "recipients", "coppa", "^comment_list", "username_list", "add", "filecomment", "poll_option_text"]
              }
              , ce: {
                dataset: ["gramm"]
              }
    ...
    appyTemplate:function(t) {
      if(!this.cacheTable) {
        ...
        for(var l=this.settings.buttonClass||this.ns.plugin+"-button", d=[ {
    ...
    prepare:function() {
      ...
      if("auto"==settings.vendor) {
        ...
        for(var s in this.vendors)if("default"!=s&&void 0!==window[this.vendors[s].check]) {
          settings.vendor=s;
          break
        }
      }
      ...
      if("default"!==settings.vendor)if(r.settings.hasOwnProperty("fitEditor")||e.dataset.hasOwnProperty("fitEditor")||(settings.fitEditor=1), settings.fitEditor)i=!r.settings.css;
        ...
        var o=["autoInsert",
          "observe",
          "observeCache"];
        for(var s in r.settings)-1!=o.indexOf(s)||e.dataset.hasOwnProperty(s)||(settings[s]=this.defaultSettings[s])
      }
      if(i)settings.css="";
      else {
