...
return [
  ...
  'ban-reason' => 'Причина',
  'banned-footer' => 'Це те, що ви отримуєте, не дотримуючись правил',
  'banned-header' => 'Вас заблокувавали',
  ...
  'username-reminder' => 'Нещодавно ви надіслали нам запит на ваше ім’я користувача в нашій програмі. Ваше ім я користувача',
  'username-sent' => 'Ваше ім я користувача надіслано на вашу адресу електронної пошти!',
