...
return [
    ...
    'current'              => 'Enquete(s) ativa(s)',
    'delete-option'        => 'Opção de excluir',
    'ip-checking'          => 'Ativar verificação de IP duplicado',
    'ip-checking'          => 'Esta enquete contém verificação de votos duplicados. Você só pode votar uma vez.',
    ...
    'vote'                 => 'Votar',
    'vote-now'             => 'Deixe sua escolha agora!',
    'votes'                => 'Votos',
];
