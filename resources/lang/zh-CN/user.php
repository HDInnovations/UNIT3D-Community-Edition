...
return [
    ...
    'invites-rules'             => '<li class="text-success">只邀请那些你信得过及了解的朋友.</li><li class="text-danger">你需要对这些邀请负个人责任.</li><li class="text-danger">不准使用马甲.</li><li class="text-danger">不准买卖邀请码.</li><li class="text-danger">如你所邀请的人因作弊或买卖帐户而被封禁，你也会被牵连.</li>',
    'invites-send'              => '邀请已发送',
    'judge'                     => '审核人',
    'last-login'                => '上次登录时间',
    'locked'                    => '未解锁',
    ...
    'private-info'              => '隐私资讯',
    'private-forum-profile'     => '注意: 这用户的标题及贴子纪录已设定为私密!',
    ...
    'visible-to-achievement-help'           => '只有Staff或以下所勾选的组别才能浏览你的成就。
    若你启动了<strong>私密模式</strong>,以下设定将会无效。',
    'visible-to-follower'       => '关注着清单能让以下用户组浏览',
    'visible-to-follower-help'  => '只有Staff或以下所勾选的组别才能浏览你的关注着清单。
    若你启动了<strong>私密模式</strong>,以下设定将会无效。',
    'visible-to-forum'          => '论坛纪录能让以下用户组浏览',
    'visible-to-forum-help'     => '只有Staff或以下所勾选的组别才能浏览你的论坛记录。
    若你启动了<strong>私密模式</strong>,以下设定将会无效。',
    'visible-to-other'          => '其他信息可见性',
    'visible-to-other-help'     => '只有Staff或以下所勾选的组别才能浏览你的其他信息。若你启动了<strong>私密模式</strong>或选择<strong>隐身</strong>,以下设定将会无效。',
    'visible-to-profile'        => '个人资料能让以下用户组浏览',
    'visible-to-profile-help'   => '只有Staff或以下所勾选的组别才能浏览你的个人资料。若你启动了<strong>私密模式</strong>,以下设定将会无效。',
    'visible-to-request'        => '悬赏信息可见性',
    'visible-to-request-help'   => '只有Staff或以下所勾选的组别才能浏览你的悬赏信息。若你启动了<strong>私密模式</strong>,以下设定将会无效。',
    'visible-to-torrent'        => '资源记录能让以下用户组浏览',
    'visible-to-torrent-help'   => '只有Staff或以下所勾选的组别才能浏览你的资源记录。若你启动了<strong>私密模式</strong>,以下设定将会无效。',
    'warned-by'                 => '警告者',
    'warned-on'                 => '警告',
    'warning'                   => '警告',
    'warnings'                  => '警告',
