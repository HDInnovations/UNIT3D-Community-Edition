...
return [
    ...
    'aboutus-welcome'       => '关于',
    'aboutus-welcome-desc'  => ':title 是一个基于社区的影音聚合网站, 所有内容都由会员无私奉献。 :title <em>致力于</em> 提供高清资源，活跃的用户群体，安全、可靠、优秀的网站程序, 以及亲切友善的Staff队伍。',
    ...
    'email-whitelist-desc'  => '允许使用以下邮箱.你只可以使用这些邮箱注册本站, 也只能把邀请码发到这些电邮.',
    'staff-group'           => 'Staff小组',
    'staff-title'           => 'Staff职称',
