...
return [
  ...
  'aboutus-rules2' => 'Каб азнаёміцца з правіламі і ў поўным аб&#39;ёме, калі ласка, паважайце іх!',
  ...
  'email-whitelist-desc' => 'Гэтыя дамены электроннай пошты з&#39;яўляюцца адзінымі паштовымі даменамі, дазволенымі да выкарыстання. Вы можаце толькі зарэгістраваныя або адправіць Запрасіць, выкарыстоўваючы наступныя.',
  'staff-group' => 'група',
