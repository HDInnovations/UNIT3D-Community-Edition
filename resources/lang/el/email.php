...
return [
    ...
    'fail-login-line2'    => 'Αυτό το αίτημα προέρχεται από: ip (: host) στις: ώρα',
    'fail-login-subject'  => 'Αποτυχημένη ειδοποίηση σύνδεσης',
    'footer-link'         => 'Αν αντιμετωπίζετε προβλήματα στο κλικ: actionText, αντιγράψτε και επικολλήστε την παρακάτω διεύθυνση URL στο πρόγραμμα περιήγησης ιστού:',
    ...
    'newreply-replied'    => 'Έχει απαντήσει στο θέμα σας',
    ...
    'pruned-header'       => 'Ο λογαριασμός σας έχει κλαδευτεί',
];
