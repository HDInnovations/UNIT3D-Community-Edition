...
return array (
  ...
  'ban-reason' => 'Λόγος',
  'banned-footer' => 'Αυτός είναι ο λόγος που παίρνετε επειδή δεν ακολουθείτε τους κανόνες',
  'banned-header' => 'Έχετε απαγορευτεί',
  'bug-description' => 'Πρόβλημα',
  'bug-footer' => 'Διορθώστε αυτό το σκατά',
  ...
  'report-header' => 'Γεια Admin, Έχει αναφερθεί ένας σύνδεσμος',
