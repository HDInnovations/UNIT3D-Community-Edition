...
return [
  ...
  'enter-bp' => 'Πληκτρολογήστε πόντους μπόνους (τουλάχιστον 100)',
  'enter-hash' => 'Εισαγάγετε το Πληροφοριακό Σημείωμα - hash - του φορτωμένου Torrent',
  'fill' => 'Γέμισμα',
  'fill-request' => 'Συμπληρώστε αυτό το αίτημα',
  'filled' => 'γέματο',
  'filled-by' => 'Γεμάτο από',
  'for' => 'Για',
  'fulfill' => 'Εκπληρώ',
  'last-vote' => 'Τελευταία ψηφος',
  'my-requests' => 'Τα αιτήματά μου',
  'no' => 'Οχι,',
  'no-imdb-id' => 'Όλα τα αιτήματα πρέπει να περιέχουν έναν αριθμό IMDB',
  ...
  'required' => 'Απαιτείται',
  'reset' => 'Επαναφορά',
  'reset-confirmation' => 'Είστε βέβαιοι ότι θέλετε να επαναφέρετε αυτό το αίτηση',
  ...
  'unfilled' => 'Απλήρωτος',
  'view-filled' => 'Η προβολή είναι γεμάτη',
  'view-unfilled' => 'Προβολή ακατάλληλων',
  'vote' => 'Ψήφος',
