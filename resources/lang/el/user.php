...
return [
  ...
  'go-public' => 'Βγές Δημόσια',
  'go-private' => 'Πήγαινε ιδιωτικός',
  'history' => 'Ιστορίκο',
  'history-table' => 'Πίνακας ιστορικού',
  'hit-n-runs' => 'Hit και Run',
  'hit-n-runs-count' => 'Αριθμός Hit και Run (Όλος ο χρόνος)',
  ...
  'no-logs' => 'Δεν υπάρχουν καμπάνιες πρόσκλησης στη βάση δεδομένων για αυτόν τον χρήστη!',
  'no-seedboxes' => 'Δεν υπάρχουν Seedboxes 😔',
  'not-authorized' => 'Δεν έχετε εξουσιοδότηση για να δείτε αυτή τη σελίδα. Αυτό το μέλος προτιμά να είναι κρυμμένο σαν το ninja!',
  'note' => 'Σημείωση',
  ...
  'torrent-notification-tip' => 'Λάβετε μια ειδοποίηση όταν ένας μεταφορτωμένος torrent παίρνει ενα νέο φιλοδώρημα',
