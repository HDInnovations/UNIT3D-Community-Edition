...
return [
  ...
  'create_a_new_files_backup' => 'Δημιουργία αντιγράφων αρχείων',
  'create_a_new_db_backup' => 'Δημιουργία αντιγράφων ασφαλείας βάσεων δεδομένων',
  'create_confirmation_message' => 'Επανατοποθετήστε τη σελίδα σε 3 δευτερόλεπτα.',
  ...
  'create_warning_message' => 'Το αντίγραφο ασφαλείας σας ΔΕΝ μπορεί να έχει δημιουργηθεί. Ελέγξτε τα αρχεία καταγραφής για λεπτομέρειες.',
