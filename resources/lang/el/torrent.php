...
return [
  ...
  'announce-url-desc2' => 'Το πεδίο TMDB και IMDB απαιτείται για όλες τις ταινίες ! Χρησιμοποιείται για να αρπάξει Αφίσες / Backdrops και ExtraInfo. Αντίστοιχα το TVDB για σειρες, το MAL για Anime, και το IGDB για παιχνιδια',
  'approved' => 'Εγκρίθηκε',
  'audio' => 'Ήχος',
  ...
  'encode-settings' => 'Rυθμίσεις κωδικοποίησης',
  ...
  'top-leeched' => 'Top ζητούνται',
  'top-seeded' => 'Top Διαμοιράζονται',
  'torrent' => 'Torrent',
