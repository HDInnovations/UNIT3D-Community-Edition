...
return [
    ...
    |--------------------------------------------------------------------------
    */
    'activation-error'       => 'Gesperrter oder ungültiger Token oder das Nutzerkonto ist bereits aktiviert!',
    'activation-success'     => 'Konto wurde aktiviert! Du kannst dich jetzt anmelden!',
    'add-image'              => 'Einen weiteren Bild Link hinzufügen',
    'add-profile'            => 'Einen weiteren Profil Link hinzufügen',
    ...
    'check-later'            => 'Komme später nochmal!',
    'delete-image'           => 'Link vom letzten Bild löschen',
    'delete-profile'         => 'Link vom letzten Profil löschen',
    'email'                  => 'E-mail',
    'failed'                 => 'Diese Anmeldedaten stimmen nicht mit unseren Datenbanken überein.',
    'invalid-key'            => 'Ungültiger oder abgelaufener Invite Schlüssel!',
    'login'                  => 'Einloggen',
    'login-now-on'           => 'Jetzt einloggen auf',
    'logout'                 => 'Ausloggen',
    'lost-password'          => 'Passwort vergessen?',
    'lost-username'          => 'Nutzername vergessen?',
    'need-invite'            => 'Offene Registrierung ist deaktiviert, du brauchst einen Invite um Zugriff zu kriegen!',
    'newbie'                 => 'Neu in der Szene?',
    'not-a-member'           => 'Noch kein Mitglied? Registriere dich in weniger als 30s.',
    'not-activated'          => 'Dieses Konto wurde nicht aktiviert und befindet sich noch in der Validierungsgruppe. Bitte prüfe deine E-Mail auf einen Aktivierungslink. Wenn du den Aktivierungscode nicht erhalten hast, klicke bitte auf "Passwort vergessen" und führe die Schritte aus.',
    'password'               => 'Passwort',
    'proof-image'            => 'Proof Bild URL',
    'proof-image-title'      => 'Links zu Profil-Screenshots',
    'proof-profile'          => 'Profil Link URL',
    'proof-profile-title'    => 'Links zu deinen Profilen',
    'proof-min'              => '(Minimum 2, Empfohlen 3)',
    'recover-my-password'    => 'Passwort zurücksetzen',
    'register-thanks'        => 'Danke für die Registrierung! Bitte überprüfe deine E-Mails, um das Konto zu aktivieren.',
    'require-rules'          => 'Bitte lese und akzeptiere unsere Regeln, indem du zum Ende der Seite scrollst.',
    'signup'                 => 'Registrieren',
    ...
    */
    ...
    'attemptsRemaining'             => 'Versuche verbleibend|Versuche verbleibend',
    'missingCode'                   => 'Keinen Verifizierungscode erhalten?',
    'verifyButton'                  => 'Verifizieren',

    'exceededTitle'                 => 'Verifizierungsversuche wurden überschritten',
