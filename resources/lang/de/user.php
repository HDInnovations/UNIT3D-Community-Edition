...
return [
    ...
    'account-notification-help'            => 'Lege fest, welche Benachrichtigungen dein Konto betreffend gesendet werden. Diese Einstellungen werden überschrieben, wenn du die Benachrichtigung aller Gruppen nicht zulässt, oder wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    'account-settings'                     => 'Konto Einstellungen',
    'account-updated'                      => 'Deine Konto-Einstellungen wurden aktualisiert!',
    ...
    'all-messages-as-read'                 => 'Deine Nachrichten wurden alle als gelesen markiert!',
    'all-torrents'                         => 'Alle Torrents',
    'already-following'                    => 'Du folgst bereits dem Nutzer',
    'already-not-following'                => 'Du folgst dem Nutzer bereits nicht',
    'api-token-changed'                    => 'Dein API Token wurde erfolgreich geändert!',
    'article-comments'                     => 'Kommentare zu Artikeln geschrieben',
    'avatar'                               => 'Avatar',
    'avatar-gif-square-error'              => 'Da du einen GIF hochlädst, muss dieser Quadratisch sein!',
    'avatar-too-large-error'               => 'Dein Avatar ist zu groß, max Datei-Größe:',
    ...
    'bon-notification-gift'                => 'Erhalte eine Benachrichtigung, wenn ein Nutzer dir Bonuspunkte gibt',
    ...
    'deleted-pm'                           => 'PN wurde erfolgreich gelöscht!',
    'disappeared-like-ninja'               => 'Du bist wie ein Ninja verschwunden!',
    'disable-notifications'                => 'Benachrichtigungen ausschalten',
    'disabled-notifications'               => 'Benachrichtigungen ausgeschaltet!',
    'disclaimer'                           => 'Disclaimer',
    'disclaimer-info'                      => 'Wir protokollieren standardmäßig keine IP-Adressen, wie die meisten Tracker. Wenn du unten deine IP-Adresse deiner Seedbox hinzufügst, gehen wir davon aus, dass dir klar ist, dass die aufgeführten IP-Adressen in unserer Datenbank gespeichert werden, sofern wir die Datensätze nicht löschen.',
    ...
    'email-updated'                        => 'Dein E-Mail wurde aktualisiert!',
    'enable-notifications'                 => 'Benachrichtigungen einschalten',
    'enabled-notifications'                => 'Benachrichtigungen eingeschaltet!',
    'error-wrong-place'                    => 'Was versuchst du hier zu tun?!',
    'expired'                              => 'Abgelaufen',
    'expires-on'                           => 'Abgelaufen am',
    'extra'                                => 'Extra',
    'filled-request'                       => 'Erfüllte Nutzer-Requests',
    'follow'                               => 'Folgen',
    'follow-yourself'                      => 'Netter versuch, leider kannst du dir nicht selber folgen.',
    ...
    'following-notification-upload'        => 'Erhalte eine Benachrichtigung, wenn ein gefolgter Nutzer einen Torrent hochlädt',
    ...
    'forum-notification-help'              => 'Kontrolliere, welche Benachrichtigungen über Forumaktivitäten gesendet werden. Diese Einstellungen werden überschrieben, wenn du die Benachrichtigung aller Gruppen nicht zulässt, oder wenn du <strong>Benachrichtigungen deaktivierst</strong>',
    ...
    'forum-privacy-topic'                  => 'Erlaube Nutzern, die Liste der Forumsthemen anzuzeigen, die du gestartet hast',
    ...
    'gone-private'                         => 'Du bist nun Privat!',
    'gone-public'                          => 'Du bist nun Öffentlich!',
    'history'                              => 'Verlauf',
    ...
    'image'                                => 'Bild',
    'image-deleted'                        => 'Bild wurde erfolgreich gelöscht',
    'image-not-found'                      => 'Bild nicht gefunden! Bitte reporte dies dem Team!',
    'image-success'                        => 'Dein Bild wurde erfolgreich veröffentlicht!',
    'important'                            => 'Wichtig',
    'important-info'                       => 'Wichtige Info',
    'information'                          => 'Information',
    'invitations-disabled'                 => 'Invitationen sind deaktiviert, da "Offene Registrierung" aktiv ist!',
    'invited-by'                           => 'Eingeladen von',
    'invite-disabled-group'                => 'Invites sind aktuell für deine Gruppe deaktiviert.',
    'invite-email-already-used'            => 'Diese E-Mail Adresse hat bereits einen Invite gekriegt.',
    'invite-friend'                        => 'Lade deinen Freund ein (E-Mail + Nachricht erforderlich)',
    'invite-resend-already-used'           => 'Den Invite den du versuchst erneut zu schicken wurde bereits benutzt.',
    'invite-resend-successfully'           => 'Invite wurde erfolgreich erneut verschickt!',
    'invite-rights-revoked'                => 'Deine Invite Rechte wurden entzogen!',
    'invite-send-successfully'             => 'Invite wurde erfolgreich verschickt!',
    'invite-tree'                          => 'Invite Hierarchie',
    'invites'                              => 'Invites',
    'invites-banned'                       => 'Fehler: Ihre Invite-Rechte wurden deaktiviert',
    'invites-banned-desc'                  => 'Wenn du das Gefühl hast, dass dies fehlerhaft ist, wende dich bitte an das Team!',
    ...
    'mention-notification-article-comment' => 'Erhalte eine Benachrichtigung, wenn du in einem Artikelkommentar @erwähnt wirst',
    'mention-notification-torrent-comment' => 'Erhalte eine Benachrichtigung, wenn du in einem Torrent-Kommentar @erwähnt wirst',
    ...
    'no-longer-following'                  => 'Du hast aufgehört %s zu folgen',
    ...
    'not-enough-invites'                   => 'Du hast nicht genügend Invites!',
    'note'                                 => 'Hinweis',
    'notification'                         => 'Benachrichtigung',
    'notification-settings'                => 'Benachrichtigungs-Einstellungen',
    'notification-account-saved'           => 'Deine Kontobenachrichtigungs-Einstellungen wurden gespeichert!',
    'notification-bon-saved'               => 'Deine Bonusbenachrichtigungs-Einstellungen wurden gespeichert!',
    'notification-follower-saved'          => 'Deine gefolgten Nutzerbenachrichtigung-Einstellungen wurden gespeichert!',
    'notification-forum-saved'             => 'Deine Forum Benachrichtigungs-Einstellungen wurden gespeichert!',
    'notification-mention-saved'           => 'Deine @Erwähnung Benachrichtigungs-Einstellungen wurden gespeichert!',
    'notification-request-saved'           => 'Deine Requestbenachrichtigungs-Einstellungen wurden gespeichert!',
    'notification-subscription-saved'      => 'Deine Abonnementbenachrichtigungen-Einstellungen wurden gespeichert!',
    'notification-torrent-saved'           => 'Deine Torrentbenachrichtigungen-Einstellungen wurden gespeichert!',
    ...
    'passkey'                              => 'PID',
    'passkey-changed'                      => 'Deine PID wurde erfolgreich geändert',
    'passkey-warning'                      => 'PID ist wie dein Passwort, du musst es sicher aufbewahren!',
    'password-has-been-reset'              => 'Dein Passwort wurde zurückgesetzt',
    'password-incorrect'                   => 'Dein Passwort ist falsch!',
    'password-too-weak'                    => 'Dein Passwort ist zu schwach!',
    ...
    'privacy-settings-saved'               => 'Deine Privatsphären-Einstellungen wurden gespeichert',
    'privacy-achievement-settings-saved'   => 'Deine Achievement Privatsphären-Einstellungen wurden gespeichert',
    'privacy-forum-history-settings-saved' => 'Deine Forum Verlauf Privatsphären-Einstellungen wurden gespeichert',
    'privacy-follower-settings-saved'      => 'Deine Follower Privatsphären-Einstellungen wurden gespeichert',
    'privacy-profile-settings-saved'       => 'Deine Profil Privatsphären-Einstellungen wurden gespeichert',
    'privacy-torrent-settings-saved'       => 'Deine Torrent Verlauf Privatsphären-Einstellungen wurden gespeichert',
    'privacy-request-settings-saved'       => 'Deine Request Privatsphären-Einstellungen wurden gespeichert',
    'private-info'                         => 'Private Info',
    'private-forum-profile'                => 'Achtung: Der Verlauf wurde auf PRIVAT gesetzt!',
    ...
    'profile-privacy-torrent-count'        => 'Teile deine Gesamtzahl an Downloads, Uploads, Seeds und Leeches',
    ...
    'reappeared-like-ninja'                => 'Du hast das Ninja Dasein beendet!',
    ...
    'request-notification'                 => 'Request Benachrichtigungs-Einstellungen',
    ...
    'request-notification-unclaim'         => 'Erhalte eine Benachrichtigung, wenn ein Request unclaimed wurde',
    ...
    'rid-changed'                          => 'Deine RID wurde erfolgreich geändert!',
    'search'                               => 'Schnelle Suche nach Nutzername',
    'security'                             => 'Sicherheit',
    'security-settings'                    => 'Sicherheits-Einstellungen',
    'seedbox-added'                        => 'Seedbox wurde erfolgreich hinzugefügt!',
    'seedbox-removed'                      => 'Seedbox wurde erfolgreich entfernt!',
    'seedboxes'                            => 'Seedboxen',
    'seeding-size'                         => 'Seed Größe',
    'seeds'                                => 'Seeds',
    'send-invite'                          => 'Sende Invite',
    'sent-pm'                              => 'Deine PN wurde erfolgreich verschickt',
    'sender'                               => 'Absender',
    'settings'                             => 'Einstellungen',
    'show-passkey'                         => 'PID anzeigen',
    'soft-deleted-warnings'                => 'Soft Gelöschte Verwarnungen',
    'something-went-wrong'                 => 'Irgendwas ist fehlgeschlagen',
    'staff-noted'                          => 'Team Notiertes Konto',
    'statistics'                           => 'Statistiken',
    'stylesheet-invalid-url'               => 'Die externe CSS Stylesheet URL ist ungültig, versuche es nochmal mit einer gültigen URL.',
    ...
    'two-step-auth-changed'                => 'Zwei Faktor Authentifizierung Status geändert!',
