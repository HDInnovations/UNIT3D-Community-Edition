...
return [
    ...
    'delete_error_message'           => 'Le fichier de sauvegarde na pas été supprimé.',
    'delete_cancel_title'            => 'Cest ok',
    'delete_cancel_message'          => 'Le fichier de sauvegarde na pas été supprimé.',
    ...
    'create_error_message'           => 'Le fichier de sauvegarde na pas pu être créé.',
    'create_warning_title'           => 'Erreur inconnue',
    'create_warning_message'         => 'Votre fichier de sauvegarde na sans doute pas pu être créé. Regardez les logs pour plus de details.',
    'location'                       => 'Emplacement',
    'no_disks_configured'            => 'Aucun "backup disks" de configuré dans config/laravel-backup.php',
    'backup_doesnt_exist'            => 'Le fichier de sauvegarde nexiste pas.',
