...
return [
  ...
  'fail-login-line2' => 'Denne anmodning stammede fra: ip (: vært) på: tid',
  'fail-login-subject' => 'Mislykket login varsling',
  'footer-link' => 'Hvis du har problemer med at klikke på knappen: actionText, skal du kopiere og indsætte webadressen nedenfor i din webbrowser:',
  ...
  'register-footer' => 'Hvis knappen ovenfor ikke virker, skal du kopiere og indsætte webadressen i adressefeltet til browseren',
  ...
  'unban-header' => 'Du har været ubannet',
  'unban-reason' => 'Grund',
  ...
  'pruned-header' => 'Din konto er blevet beskåret',
];
