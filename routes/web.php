    ...
    */
    Route::group(['middleware' => ['auth', 'twostep', 'banned']], function () {
        ...
        Route::group(['prefix' => 'torrents'], function () {
            ...
            Route::get('/{id}/torrent_promo50', [App\Http\Controllers\TorrentController::class, 'grant50'])->name('torrent_promo50');
            Route::get('/{id}/torrent_promo25', [App\Http\Controllers\TorrentController::class, 'grant25'])->name('torrent_promo25');
